...
return [
    ...
    */
    ...
    'between' => [
        ...
        'string' => 'يجب أن يكون طول حقل كلمة المرور بين :min و :max حرفًا.',
    ],
    ...
    'min' => [
        ...
        'string' => 'يجب أن يكون طول حقل كلمة المرور على الأقل :min حرفًا.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'حقل :attribute المقدم قد ظهر في تسرب بيانات. الرجاء اختيار :attribute مختلف.',
    ],
    ...
    | الصيغة "attribute.rule" لتسمية الخطوط. هذا يجعل من السهل
    | تحديد خط لغة مخصص معين لقانون سمة معين.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | تُستخدم خطوط اللغة التالية لاستبدال عنصر نائب السمة الخاص بنا
    | بشيء أكثر ودية للقراء مثل "عنوان البريد الإلكتروني" بدلاً
    | من "email". هذا يساعدنا ببساطة في جعل رسالتنا أكثر تعبيرًا.
    |
    */
