...
namespace App\Http\Controllers\Tasks\Task;
    ...
    */
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            'task_field' => 'nullable|in:offers,contracts,projects,lawsuits,sessions,power_of_attorney,marketing,other',
        ...
        */
        ...
        if ($task->task_field != null) {
            if ($task->project_id) {
                ...
                return redirect()->to(route('legal-affairs.lawsuits.show', $task->lawsuit_id) . '#tasks')
