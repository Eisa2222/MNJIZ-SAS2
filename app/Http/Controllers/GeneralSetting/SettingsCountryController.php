...
class SettingsCountryController extends Controller
{
    ...
    {
        $this->middleware('can:قائمة الدول')->only([
            'index',
            'edit',
            'store',
            'update',
    ...
    protected $model = SettingsCountry::class;

    public function index()
    {
        return $this->index_trait($this->model,'general_setting.settings_country','settings-country');
    }
