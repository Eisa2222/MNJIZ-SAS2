...
class SettingsRegionController extends Controller
{
    public function __construct()
    {
        $this->middleware('can:المدن')->only([
            'index',
            'edit',
            'store',
            'update',
    ...
    protected $model = SettingsRegion::class;

    public function index()
    {
        return $this->index_trait($this->model,'general_setting.settings_regions','settings-region');
    }
