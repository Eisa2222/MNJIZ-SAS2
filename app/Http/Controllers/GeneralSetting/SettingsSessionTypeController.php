...
class SettingsSessionTypeController extends Controller
{

    public function __construct()
    {
        $this->middleware('can:أنواع الجلسات')->only([
            'index',
            'edit',
            'store',
            'update',
    ...
    protected $model = SettingsSessionType::class;

    public function index()
    {
        return $this->index_trait($this->model,'general_setting.settings_session_type' ,'settings-session-type');
    }
