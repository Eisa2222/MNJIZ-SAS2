...
class SettingsMarketingChannelController extends Controller
{
    public function __construct()
    {
        $this->middleware('can:قنوات التسويق')->only([
            'index',
            'edit',
            'store',
            'update',
    ...
    protected $model = SettingsMarketingChannel::class;

    public function index()
    {
        return $this->index_trait($this->model, 'general_setting.settings_marketing_channel', 'settings-marketing-channel');
    }
