...
class SettingsClientStatusController extends Controller
{

    public function __construct()
    {
        $this->middleware('can:حالات العميل')->only([
            'index',
            'edit',
            'store',
            'update',
    ...
    protected $model = SettingsClientStatus::class;

    public function index()
    {
        return $this->index_trait($this->model,'general_setting.settings_client_status' ,'settings-client-status');
    }
