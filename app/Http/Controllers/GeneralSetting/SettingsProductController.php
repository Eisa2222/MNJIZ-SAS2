...
class SettingsProductController extends Controller
{

    public function __construct()
    {
        $this->middleware('can:المنتجات')->only([
            'index',
            'edit',
            'store',
            'update',
    ...
    protected $model = SettingsProduct::class;

    public function index()
    {
        return $this->index_trait($this->model, 'general_setting.settings_product', 'settings-products');
    }
