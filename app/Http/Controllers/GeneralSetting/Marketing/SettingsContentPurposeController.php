...
class SettingsContentPurposeController extends Controller
{
    public function __construct()
    {
        $this->middleware('can:أهداف الحملات والمحتوى')->only([
            'index',
            'edit',
            'store',
            'update',
    ...
    protected $model = SettingsContentPurpose::class;

    public function index()
    {
        return $this->index_trait($this->model, 'general_setting.marketing.settings_content_purpose', 'settings-content-purpose');
    }
