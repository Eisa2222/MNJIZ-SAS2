...
class SettingsContentTypesController extends Controller
{
    public function __construct()
    {
        $this->middleware('can:أنواع الحملات والمحتوى')->only([
            'index',
            'edit',
            'store',
            'update',
    ...
    protected $model = SettingsContentType::class;

    public function index()
    {
        return $this->index_trait($this->model, 'general_setting.marketing.settings_content_types', 'settings-content-types');
    }
