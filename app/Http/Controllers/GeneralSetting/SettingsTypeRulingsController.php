...
class SettingsTypeRulingsController extends Controller
{

    public function __construct()
    {
        $this->middleware('can:أنواع الاحكام')->only([
            'index',
            'edit',
            'store',
            'update',
    ...
    protected $model = SettingsTypeRulings::class;

    public function index()
    {
        return $this->index_trait($this->model,'general_setting.settings_rule_type' ,'settings-rule-type');
    }
