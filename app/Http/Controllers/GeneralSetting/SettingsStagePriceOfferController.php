...
class SettingsStagePriceOfferController extends Controller
{

    public function __construct()
    {
        $this->middleware('can:مراحل عروض الأسعار')->only([
            'index',
            'edit',
            'store',
            'update',
    ...
    protected $model = SettingsStagePriceOffer::class;

    public function index()
    {
        return $this->index_trait($this->model,'general_setting.SettingsStagePriceOffer' ,'settings-stage-priceOffer');
    }
