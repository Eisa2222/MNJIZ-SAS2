...
class UpdatCustomerRequest extends FormRequest
{
    ...
    protected function commonRules(int $customerId): array
    {
        return [
            ...
            'contact_number'            => [
                ...
                'string',
                'max:15',
                Rule::unique('customers', 'contact_number')->ignore($customerId)
            ],
    ...
    protected function typeSpecificRules(): array
    {
        ...
        if ($type === 'company') {
            return [
                ...
                'authorizations.*.email'         => ['nullable', 'email', 'max:255'],
            ];
        }
