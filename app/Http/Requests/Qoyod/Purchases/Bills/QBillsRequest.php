...
namespace App\Http\Requests\Qoyod\Purchases\Bills;

use Illuminate\Foundation\Http\FormRequest;

class QBillsRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'due_date.date_format'          => 'صيغة تاريخ الاستحقاق يجب أن تكون YYYY-MM-DD.',
            'due_date.after_or_equal'       => 'تاريخ الاستحقاق يجب أن يكون مساوٍ أو بعد تاريخ الإصدار.',
