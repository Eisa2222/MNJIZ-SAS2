...
class QProductsStoreRequest extends FormRequest
{
    /*
    |============================================================================
    | Authorize
    ...
    */
    public function rules(): array
    {
        ...
        return [
            ...
            'type'                   => ['required', 'string', 'in:Service,Expense'],
    ...
    */
    public function messages()
    {
        return [
            ...
            // Type
            'type.required'                 => 'حقل نوع المنتج مطلوب.',
            'type.in'                       => 'نوع المنتج غير صالح. القيم المسموح بها: Service أو Expense.',
