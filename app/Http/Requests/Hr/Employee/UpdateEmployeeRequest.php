...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    */
    public function rules(): array
    {
        ...
        $userId   = optional($employeeId->user)->id;
        ...
        $rules = [
            ...
            'id_number'                         => ['required', 'digits:10', Rule::unique('employees', 'id_number')->ignore($employeeId)],
            ...
            'work_email'                        => ['required', 'email', 'max:255', Rule::unique('employees', 'work_email')->ignore($employeeId), Rule::unique('users', 'email')->ignore($userId),],
