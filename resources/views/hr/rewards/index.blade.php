    ...
    @section('title', 'المكافأت')

    @section('breadcrumb')
        <li><a href="#">الموارد البشرية</a></li>
        <li class="breadcrumb-item d-flex align-items-center">
            <a href="#">المكافأت</a>
            <i class="ti ti-star favorite-icon" data-page-name="المكافأت" data-page-url="{{ url()->current() }}"
    ...
    @section('page-script')
        @vite(['resources/assets/js/hr/rewards/rewards.js'])
    @endsection
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                <span class="text-heading">المكافأت</span>
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="mb-0 me-2">{{ $totalReward }}</h4>
                                </div>
                                <small class="mb-0">إجمالي المكافأت</small>
                            </div>
                            <div class="avatar">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                ...
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="mb-0 me-2">{{ $pendingReward }}</h4>
                                </div>
                                <small class="mb-0"> إجمالي المكافأت الجديدة </small>
                            </div>
                            <div class="avatar">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                <span class="text-heading">المكافأت المعتمدة</span>
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="mb-0 me-2">{{ $approvedReward }}</h4>
                                </div>
                                <small class="mb-0"> إجمالي المكافأت المعتمدة</small>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                <span class="text-heading">المكافأت المرفوضة</span>
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="mb-0 me-2">{{ $rejectedReward }}</h4>
                                </div>
                                <small class="mb-0"> إجمالي المكافأت المرفوضة</small>
                            </div>
                            <div class="avatar">
        ...
        <div class="card">
            <div class="card-body">
                <div class="filters row g-3">
                    ...
                    <div class="col-md-4">
                        <label for="filter-type">نوع المكافأة</label>
                        <select id="filter-type" class="form-control select2" data-placeholder="اختر نوع المكافأة">
                            <option value=""></option>
                    ...
                    <div class="col-md-4">
                        <label for="filter-status">حالة المكافأة</label>
                        <select id="filter-status" class="form-control select2" data-placeholder="اختر  حالة المكافأة">
                            <option value=""></option>
                            @foreach ($rewardStatus as $status)
