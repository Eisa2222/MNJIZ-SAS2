...
@section('title', 'إضافة انتهاك جديد')
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item d-flex align-items-center"><a href="#">إضافة انتهاك جديد</a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة انتهاك  جديد" data-page-url="{{ url()->current() }}"
...
@section('page-script')
    ...
    <script>
        $(document).ready(function() {
            ...
            function checkOccurrenceCount(employeeId, violationId) {
            ...
            function updateOccurrenceInfo() {
                ...
                if (employeeId && violationId) {
                    checkOccurrenceCount(employeeId, violationId);
                }
            }
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    <form id="violations-penalties-form" action="{{ route('hr.violations-penalties.store') }}"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="datetime-local" name="violation_date" id="violation_date" class="form-control"
                                        value="{{ old('violation_date',now()->format('Y-m-d\TH:i')) }}" max="{{ now()->format('Y-m-d\TH:i') }}" required>
                                        ...
                                        @foreach ($categorizedViolations as $category => $violations)
                                            <optgroup label="{{ $category }}">
                                                @foreach ($violations as $violation)
                                                    <option value="{{ $violation->id }}">{{ $violation->description }}
                                                    </option>
                                                @endforeach
                                            </optgroup>
                                        @endforeach
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="appeal_days" name="appeal_days"
                                        value="{{ old('appeal_days', 5) }}" min="1" max="30"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="notes" id="notes" class="form-control" rows="3"
                                        placeholder="قم بإضافة بعض الملاحظات هنا  ....">{{ old('notes') }}</textarea>
                                    @error('notes')
