...
@section('title', 'تفاصيل الخصم المالي ')

@section('breadcrumb')
    <li><a href="#">الموارد البشرية</a></li>
    <li><a href="{{ route('hr.deductions.index') }}">الخصومات</a></li>
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#">تفاصيل الخصم المالي</a>
        <i class="ti ti-star favorite-icon" data-page-name="تفاصيل الخصم المالي" data-page-url="{{ url()->current() }}"
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped small text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('account.employee.profile', $deduction->employee_id) }}">
                                        {{ $deduction->employee->getRawNameAttribute() }}
                                    </a>
                                </td>
                            </tr>

                            <tr>
                                <td class="fw-bold">نوع الخصم المالي</td>
                                <td>{{ $deduction->deduction_type->label() }}</td>
                            </tr>

                            <tr>
                                <td class="fw-bold">تاريخ الخصم المالي</td>
                                <td>{{ $deduction->deduction_date }}</td>
                            </tr>

                            <tr>
                                <td class="fw-bold">المبلغ</td>
                                <td>{{ number_format($deduction->amount, 2) }} <span class="icon-saudi_riyal"></span></td>
                            </tr>
                        ...
                        <div class="card-body d-flex align-items-center justify-content-center">
                            <div class="text-center">
                                ...
                                @if ($deduction->updated_at)
                                    <small
                                        class="text-muted d-block">{{ $deduction->updated_at->format('d/m/Y H:i') }}</small>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="timeline">
                            <li class="timeline-item">
                                ...
                                <div class="timeline-event">
                                    ...
                                    <small class="text-muted d-block">{{ $deduction->created_at }}</small>
                                    <small>
                                        <b>اضيف بواسطة</b>
                                        <a href="{{ route('account.employee.profile', $deduction->created_by) }}">
                                            {{ $deduction->createdBy->getRawNameAttribute() }}
                                        </a>
                                    </small>
                                </div>
                            </li>

                            @if ($deduction->updated_by)
                                <li class="timeline-item">
                                    <span class="timeline-point bg-success"></span>
                                    <div class="timeline-event">
                                        <small class="timeline-title text-capitalize">تم التعديل بتاريخ</small>
                                        <small class="text-muted d-block">{{ $deduction->updated_at }}</small>
                                        <small>
                                            <b>التعديل بواسطة</b>
                                            <a href="{{ route('account.employee.profile', $deduction->updated_by) }}">
                                                {{ $deduction->updatedBy->getRawNameAttribute() }}
                                            </a>
                                        </small>
                                    </div>
                                </li>
