...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#">إضافة خصم مالي</a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة خصم مالي" data-page-url="{{ url()->current() }}"
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    @endif
                    <form id="form" action="{{ route('hr.deductions.store') }}" method="POST"
                            ...
                            <div class="row g-3">
                                    ...
                                    <select id="deduction_type" name="deduction_type" class="form-select select2"
                                        ...
                                        @foreach ($deductionTypes as $type)
                                            <option value="{{ $type['id'] }}"
                                                {{ old('deduction_type') == $type['id'] ? 'selected' : '' }}>
                                                {{ $type['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" id="deduction_date" name="deduction_date" class="form-control"
                                        value="{{ old('deduction_date') }}" required>
                                </div>
