...
@section('title', 'طلب عهدة لموظف')

@section('breadcrumb')
    <li><a href="#">الموارد البشرية</a></li>
    <li><a href="{{ route('hr.custody.requests.index') }}">طلبات العهد</a></li>
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> طلب عهدة لموظف</a>
        <i class="ti ti-star favorite-icon" data-page-name=" طلب  عهدة لموظف" data-page-url="{{ url()->current() }}"
...
@section('page-script')
    ...
    @vite(['resources/assets/js/hr/custody/custody_requests_wizard.js', 'resources/assets/js/hr/custody/create-assign.js'])
@endsection
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    <form id="form" action="{{ route('hr.custody.requests.assign.store') }}" method="POST"
