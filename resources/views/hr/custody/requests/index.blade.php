    ...
    @section('title', 'طلبات العهد')

    @section('breadcrumb')
        <li><a href="#">الموارد البشرية</a></li>
        <li class="breadcrumb-item d-flex align-items-center">
            <a href="#">طلبات العهد</a>
            <i class="ti ti-star favorite-icon" data-page-name="طلبات العهد" data-page-url="{{ url()->current() }}"
    ...
    @section('page-script')
        @vite(['resources/assets/js/hr/custody/requests.js'])
    @endsection
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                <span class="text-heading">طلبات العهد</span>
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="mb-0 me-2">{{ $totalRequests }}</h4>
                                </div>
                                <small class="mb-0">إجمالي طلبات العهد</small>
                            </div>
                            <div class="avatar">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                ...
                                <small class="mb-0"> إجمالي طلبات العهد الجديدة </small>
                            </div>
                            <div class="avatar">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                <span class="text-heading">طلبات العهد المعتمدة</span>
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="mb-0 me-2">{{ $approvedRequests }}</h4>
                                </div>
                                <small class="mb-0"> إجمالي طلبات العهد المعتمدة</small>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                <span class="text-heading">طلبات العهد المرفوضة</span>
                                <div class="d-flex align-items-center my-1">
                                    <h4  class="mb-0 me-2">{{ $rejectedRequests }}</h4>
                                </div>
                                <small class="mb-0"> إجمالي طلبات العهد المرفوضة</small>
                            </div>
                            <div class="avatar">
        ...
        <div class="card">
            <div class="card-body">
                <div class="filters row g-3">
                    ...
                    <div class="col">
                        <label for="filter-item">العهدة</label>
                        <select id="filter-item" class="form-control select2" data-placeholder="اختر العهدة">
                            <option value=""></option>
                            @foreach ($custodyItems as $item)
                                <option value="{{ $item->id }}">{{ $item->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col">
                        <label for="filter-type">نوع الطلب</label>
