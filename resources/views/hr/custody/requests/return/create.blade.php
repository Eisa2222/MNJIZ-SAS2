...
@section('title', 'طلب إرجاع عهدة لموظف')

@section('breadcrumb')
    <li><a href="#">الموارد البشرية</a></li>
    <li><a href="{{ route('hr.custody.requests.index') }}">طلبات العهد</a></li>
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> طلب إرجاع عهدة لموظف</a>
        <i class="ti ti-star favorite-icon" data-page-name=" طلب  إرجاع عهدة لموظف" data-page-url="{{ url()->current() }}"
...
@section('page-script')
    <script>
        ...
        window.appData = {
            // في صفحة الإضافة سيأخذ القيمة القديمة أو يبقى فارغاً:
            selectedParentRequestId: "{{ old('parent_request_id', $custody_request->parent_request_id ?? '') }}"
        };
    </script>
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    <form id="form" action="{{ route('hr.custody.requests.return.store') }}" method="POST">
                        @csrf
