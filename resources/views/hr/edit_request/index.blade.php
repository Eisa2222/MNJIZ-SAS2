    ...
    @section('title', 'طلبات تعديل البيانات الشخصية ')

    @section('breadcrumb')
        <li><a href="#">الموارد البشرية</a></li>
        <li class="breadcrumb-item d-flex align-items-center">
            <a href="#">طلبات تعديل البيانات الشخصية </a>
            <i class="ti ti-star favorite-icon" data-page-name="طلبات تعديل البيانات الشخصية "
