...
@section('title', ' الموظفين المؤرشفين')

@section('breadcrumb')
    <li><a href="#"> الموارد البشرية</a></li>
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> الموظفين المؤرشفين</a>
        <i class="ti ti-star favorite-icon" data-page-name=" الموظفين المؤرشفين" data-page-url="{{ url()->current() }}"
