...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item d-flex align-items-center"><a href="#">تعديل بيانات الموظف</a>
        <i class="ti ti-star favorite-icon" data-page-name="تعديل بيانات الموظف" data-page-url="{{ url()->current() }}"
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    @endif
                    <form id="employee-form" action="{{ route('hr.employees.update', $employee->id) }}" method="POST"
                        ...
                        <div id="personal-info" class="content">
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <label for="national_number" class="form-label">الرقم الوظيفي </label>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="gender" name="gender" class="form-select select2"
                                        ...
                                        <option value=""></option>
                                        <option value="male"
                                            {{ old('gender', $employee->gender) == 'male' ? 'selected' : '' }}>ذكر</option>
                                        <option
                                            value="female"{{ old('gender', $employee->gender) == 'female' ? 'selected' : '' }}>
                                            أنثى</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="qualification_degree" name="qualification_degree"
                                        ...
                                        <option value=""></option>
                                        @foreach ($qualificationDegree as $degree)
                                            <option value="{{ $degree['id'] }}"
                                                {{ old('qualification_degree', $employee->qualification_degree?->value) == $degree['id'] ? 'selected' : '' }}>
                                                {{ $degree['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="knowledge_area" name="knowledge_area" class="form-select select2"
                                        ...
                                        <option value=""></option>
                                        @foreach ($knowledgeArea as $area)
                                            <option value="{{ $area['id'] }}"
                                                {{ old('knowledge_area', $employee->knowledge_area?->value) == $area['id'] ? 'selected' : '' }}>
                                                {{ $area['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row g-3">
                                    ...
                                    <select id="hr_status_id" name="hr_status_id" class="form-select select2" required
                                        ...
                                        @foreach ($statuses as $statuse)
                                            <option value="{{ $statuse->id }}"
                                                {{ old('hr_status_id', $employee->hr_status_id) == $statuse->id ? 'selected' : '' }}>
                                                {{ $statuse->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select id="bank_account_type" name="bank_account_type" class="form-select select2"
                                        ...
                                        @foreach ($banks as $bank)
                                            <option value="{{ $bank->id }}"
                                                {{ old('bank_account_type', $employee->bank_account_type) == $bank->id ? 'selected' : '' }}>
                                                {{ $bank->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select id="license_type" name="license_type" class="form-select select2"
                                        ...
                                        @foreach ($licenseType as $type)
                                            <option value="{{ $type['id'] }}"
                                                {{ old('license_type', $employee->license_type?->value) == $type['id'] ? 'selected' : '' }}>
                                                {{ $type['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="law_license_number" name="law_license_number"
                                        class="form-control numeric-only"
                                        value="{{ old('law_license_number', $employee->law_license_number) }}" />
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" id="law_license_end_date" name="law_license_end_date"
                                        class="form-control"
                                        value="{{ old('law_license_end_date', $employee->law_license_end_date ? $employee->law_license_end_date->format('Y-m-d') : '') }}" />
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="training_number" name="training_number"
                                        class="form-control numeric-only"
                                        value="{{ old('training_number', $employee->training_number) }}" />
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" id="training_end_date" name="training_end_date"
                                        class="form-control"
                                        value="{{ old('training_end_date', $employee->training_end_date ? $employee->training_end_date->format('Y-m-d') : '') }}" />
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="contract_type" name="contract_type" class="form-select select2"
                                        ...
                                        @foreach ($contractType as $type)
                                            <option value="{{ $type['id'] }}"
                                                {{ old('contract_type', $employee->contract_type?->value) == $type['id'] ? 'selected' : '' }}>
                                                {{ $type['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="trial_period" name="trial_period" class="form-select select2"
                                        ...
                                        @foreach ($trialPeriod as $type)
                                            <option value="{{ $type['id'] }}"
                                                {{ old('trial_period', $employee->trial_period?->value) == $type['id'] ? 'selected' : '' }}>
                                                {{ $type['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" id="work_license_end_date" name="work_license_end_date"
                                        class="form-control"
                                        value="{{ old('work_license_end_date', $employee->work_license_end_date ? $employee->work_license_end_date->format('Y-m-d') : '') }}" />
                                </div>
                                    ...
                                    <select id="insurance_status" name="insurance_status" class="form-select select2"
                                        ...
                                        @foreach ($insuranceStatus as $status)
                                            <option value="{{ $status['id'] }}"
                                                {{ old('insurance_status', $employee->insurance_status?->value) == $status['id'] ? 'selected' : '' }}>
                                                {{ $status['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    @if ($employee->profile_picture)
                                        <small class="form-text text-muted">الملف الحالي: <a
                                                href="{{ Storage::url($employee->profile_picture) }}"
                                                target="_blank">عرض</a></small>
                                    @endif
                                </div>
                                <div class="col-md-3">
                                    ...
                                    @if ($employee->resume)
                                        <small class="form-text text-muted">الملف الحالي: <a
                                                href="{{ Storage::url($employee->resume) }}"
                                                target="_blank">عرض</a></small>
                                    @endif
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    @if ($employee->contract_attachment)
                                        <small class="form-text text-muted">الملف الحالي: <a
                                                href="{{ Storage::url($employee->contract_attachment) }}"
                                                target="_blank">عرض</a></small>
                                    @endif
                                </div>
                                <div class="col-md-3">
                                    ...
                                    @if ($employee->id_attachment)
                                        <small class="form-text text-muted">الملف الحالي: <a
                                                href="{{ Storage::url($employee->id_attachment) }}"
                                                target="_blank">عرض</a></small>
                                    @endif
                                </div>
                                <div class="col-md-3">
                                    ...
                                    @if ($employee->bank_account_attachment)
                                        <small class="form-text text-muted">الملف الحالي: <a
                                                href="{{ Storage::url($employee->bank_account_attachment) }}"
                                                target="_blank">عرض</a></small>
                                    @endif
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    @if ($employee->signature)
                                        <small class="form-text text-muted">التوقيع الحالي:
                                            <a href="{{ Storage::url($employee->signature) }}" target="_blank">عرض</a>
                                        </small>
                                    @endif
                                </div>
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <div id="additional-attachments-container">
                                        @if ($employee->additional_attachments)
                                            @foreach ($employee->additional_attachments as $index => $attachment)
                                                <div class="row mb-3" data-attachment-id="{{ $index }}">
                                                    <div class="col-md-5">
                                                        <input type="text"
                                                            name="additional_attachments[{{ $index }}][name]"
                                                            class="form-control" placeholder="اسم المرفق"
                                                            value="{{ $attachment['name'] }}" />
                                                        <input type="hidden"
                                                            name="additional_attachments[{{ $index }}][id]"
                                                            value="{{ $index }}" />
                                                        @if (isset($attachment['file']))
                                                            <input type="hidden"
                                                                name="additional_attachments[{{ $index }}][existing_file]"
                                                                value="{{ $attachment['file'] }}" />
                                                        @endif
                                                    </div>
                                                    <div class="col-md-5">
                                                        <input type="file"
                                                            name="additional_attachments[{{ $index }}][file]"
                                                            class="form-control" />
                                                        @if (isset($attachment['file']))
                                                            <small class="form-text text-muted">الملف الحالي:
                                                    ...
                                                    <div class="col-md-2">
                                                        <button type="button" class="btn btn-danger remove-attachment"
                                                            data-attachment-id="{{ $index }}">حذف</button>
                                                    </div>
                                                </div>
                                            @endforeach
                                        @endif
