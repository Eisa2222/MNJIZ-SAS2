                ...
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            <span class="text-heading">السياسات و اللوائح</span>
                            <div class="d-flex align-items-center my-1">
                                <h4 class="mb-0 me-2">{{ $totalDoc }}</h4>
                            </div>
                            <small class="mb-0">إجمالي السياسات و اللوائح</small>
                        </div>
                        <div class="avatar">
        ...
        <div class="col-sm-6 col-xl-4">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            <span class="text-heading">السياسات و اللوائح الإلزامية</span>
                            <div class="d-flex align-items-center my-1">
                                <h4 class="mb-0 me-2">{{ $isMandatory }}</h4>
                            </div>
                            <small class="mb-0">إجمالي السياسات و اللوائح الإلزامية</small>
                        </div>
                        <div class="avatar">
                            <span class="avatar-initial rounded bg-label-danger">
                                <i class="ti ti-shield-exclamation ti-26px"></i>
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-6 col-xl-4">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            <span class="text-heading">السياسات و اللوائح الإختيارية</span>
                            <div class="d-flex align-items-center my-1">
                                <h4 class="mb-0 me-2">{{ $notMandatory }}</h4>
                            </div>
                            <small class="mb-0">إجمالي السياسات و اللوائح الإختيارية</small>
                        </div>
                        <div class="avatar">
