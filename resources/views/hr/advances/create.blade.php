...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#">إضافة سلفة</a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة سلفة" data-page-url="{{ url()->current() }}"
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    @endif
                    <form id="form" action="{{ route('hr.advances.store') }}" method="POST"
                            ...
                            <div class="row g-3">
                                    ...
                                    <select id="advance_type" name="advance_type" class="form-select select2"
                                        ...
                                        @foreach ($advanceTypes as $type)
                                            <option value="{{ $type['id'] }}"
                                                {{ old('advance_type') == $type['id'] ? 'selected' : '' }}>
                                                {{ $type['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" id="advance_date" name="advance_date" class="form-control"
                                        value="{{ old('advance_date') }}" required>
                                </div>
