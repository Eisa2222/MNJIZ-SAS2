...
@section('title', 'طلبات مراجعة المرتب للموظف')
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item d-flex align-items-center"><a href="#">طلبات مراجعة المرتب للموظف</a>
        <i class="ti ti-star favorite-icon" data-page-name="طلبات مراجعة المرتب للموظف" data-page-url="{{ url()->current() }}"
