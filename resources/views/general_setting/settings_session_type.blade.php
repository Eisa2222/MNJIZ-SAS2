...
@section('title', 'إعدادات انواع الجلسات ')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات انواع الجلسات</a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات انواع الجلسات" data-page-url="{{ url()->current() }}"
        ...
        var table = $('#setting-table').DataTable({
            ...
            , buttons: [{
                        ...
                        , {
                            ...
                            , action: function(e, dt, node, config) {
                                ...
                                confirmDeleteSelectedmss(selectedIds
                                    , "{{ route('mass.delete') }}", 'SettingsSessionType'
                ...
                ,
                 ...
                 {
                    text: '<i class="fas fa-plus-circle me-1"></i> إضافة نوع جلسة  جديد'
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="text-center mb-6">
                    <h4 class="mb-2">إضافة نوع جلسة جديد</h4>
                    <p> انواع الجلسات </p>
                </div>
                <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}" method="POST">
                    ...
                    <div class="col-12 mb-4">
                        <label class="form-label" for="modalSettingName">اسم
                            نوع الجلسة </label>
                        <input type="text" id="modalSettingName" name="name" class="form-control" placeholder="اسم نوع الجلسة " required />
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback"> اسم نوع الجلسة مطلوب
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-simple">
        <div class="modal-content">
            <div class="modal-body">
                <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="text-center mb-6">
                    <h4 class="mb-2">تعديل بيانات نوع الجلسة</h4>
                    <p>انواع الجلسات</p>
                </div>
                <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                    ...
                    @method('PUT')
                    <div class="col-12 mb-4">
                        <label class="form-label" for="modalSettingNameEdit"> اسم نوع الجلسة </label>
                        <input type="text" id="modalSettingNameEdit" name="name" class="form-control" placeholder="اسم نوع الجلسة " required />
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback">اسم نوع الجلسة مطلوب</div>
                    </div>
                    <div class="col-12 text-center demo-vertical-spacing">
