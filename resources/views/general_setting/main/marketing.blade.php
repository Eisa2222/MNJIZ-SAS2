...
@section('title', 'إعدادت التسويق')

@section('breadcrumb')
    <li><a href="{{ route('general-settings.index') }}">الإعدادات العامة</a></li>
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادت التسويق</a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادت التسويق" data-page-url="{{ url()->current() }}"
            ...
            <div class="card">
                <div class="card-body py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <p class="mb-0">إعدادت التسويق</p>
                            <small class="text-muted mb-0">
                                تعريف قنوات التسويق، أنواع الحملات، وأهداف المحتوى
                            </small>
                        </div>
                    </div>
                </div>
