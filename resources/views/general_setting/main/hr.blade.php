...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات الموارد البشرية</a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات الموارد البشرية" data-page-url="{{ url()->current() }}"
            ...
            <div class="card">
                <div class="card-body py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <p class="mb-0">إعدادات الموارد البشرية</p>
                            <small class="text-muted mb-0">
                                التحكم في تصنيفات الموظفين، الإجازات، المخالفات والمزايا
                            </small>
                        </div>
                    </div>
                </div>
