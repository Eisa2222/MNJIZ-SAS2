...
@section('title', 'إعدادات مركز المشتريات')

@section('breadcrumb')
    <li><a href="{{ route('general-settings.index') }}">الإعدادات العامة</a></li>
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات مركز المشتريات</a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات مركز المشتريات" data-page-url="{{ url()->current() }}"
            ...
            <div class="card">
                <div class="card-body py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <p class="mb-0">إعدادات مركز المشتريات</p>
                            <small class="text-muted mb-0">
                                ضبط فئات المشتريات، الموردين ومسارات أوامر الشراء
                            </small>
                        </div>
                    </div>
                </div>
