...
@section('title', ' إعدادات قنوات التسويق')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات قنوات التسويق</a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات قنوات التسويق" data-page-url="{{ url()->current() }}"
        ...
        $(document).ready(function() {
            ...
            var table = $('#setting-table').DataTable({
                ...
                buttons: [{
                    ...
                    {
                        text: '<i class="fas fa-plus-circle me-1"></i> إضافة قناة تسويقية جديدة',
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">إضافة قناة تسويقية جديدة</h4>
                        <p>قنوات التسويق</p>
                    </div>
                    <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}"
                        ...
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingName">اسم
                                حالة قناة التسويق</label>
                            <input type="text" id="modalSettingName" name="name" class="form-control"
                                placeholder="اسم حالة قناة التسويق" required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback"> اسم حالة قناة التسويق مطلوب
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="text-center mb-6">
                        <h4 class="mb-2">تعديل بيانات القناة التسويقية</h4>
                        <p> قنوات التسويق </p>
                    </div>
                    <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                        ...
                        @method('PUT')
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingNameEdit">اسم قناة التسويق</label>
                            <input type="text" id="modalSettingNameEdit" name="name" class="form-control"
                                placeholder="اسم قناة التسويق" required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">اسم قناة التسويق مطلوب</div>
                        </div>
                        <div class="col-12 text-center demo-vertical-spacing">
