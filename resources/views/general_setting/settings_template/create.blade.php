...
@section('title', 'إضافة نموذج جديد')

@section('breadcrumb')
    <li><a href="{{ route('settings-templates.index') }}">النماذج</a></li>
    <li class="breadcrumb-item d-flex align-items-center"><a href="#">إضافة نموذج جديد</a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة نموذج جديد" data-page-url="{{ url()->current() }}"
...
@section('content')
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                    ...
                    <div class="step" data-target="#basic-info">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label mt-1">
                                ...
                                <span class="bs-stepper-subtitle">تفاصيل النموذج</span>
                            </span>
                        </button>
                    </div>
                    ...
                    <div class="step" data-target="#additional-info">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label mt-1">
                                ...
                                <span class="bs-stepper-subtitle">تفاصيل إضافية عن النموذج</span>
                            </span>
                        </button>
                    </div>
                    ...
                    <div class="step" data-target="#preview-info">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label mt-1">
                                ...
                                <span class="bs-stepper-subtitle">معاينة النموذج المكتوب</span>
                            </span>
                        </button>
                    </div>
                ...
                <div class="bs-stepper-content">
                    ...
                    @endif
                    <form id="template-form" action="{{ route('settings-templates.store') }}" method="POST"
                        ...
                        <div id="basic-info" class="content dstepper-block">
                            <div class="row g-6">
                                ...
                                <div class="col-md-6">
                                    <label for="templates_type" class="form-label">نوع النموذج</label>
                                    <select id="templates_type" name="templates_type" class="form-select select2" required
                                        data-placeholder="اختر النوع المناسب">
                                        <option value=""></option>
                                        <option value="offers" {{ old('templates_type') == 'offers' ? 'selected' : '' }}>
                                            نموذج خاص للعروض</option>
                                        <option value="contracts"
                                            {{ old('templates_type') == 'contracts' ? 'selected' : '' }}>نموذج خاص للعقود
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div id="preview-info" class="content">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div id="template-preview" class=" p-3">
                                        <div id="template-content" class="text-center"
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <button type="submit" class="btn btn-primary btn-submit">حفظ النموذج</button>
                            </div>
                        </div>
    ...
    <!-- تمرير قيمة المتغير النوعي القديم (إذا وجدت) -->
    <script>
        const oldType = "{{ old('templates_type') }}";
    </script>
@endsection
...
@section('page-script')
    ...
    <script>
        $(document).ready(function() {
            ...
            const templatesTypeSelect = $('#templates_type');
