...
@section('title', 'إعدادات مراحل عروض الاسعار')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات  مراحل عروض الاسعار</a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات مراحل عروض الاسعار " data-page-url="{{ url()->current() }}"
        ...
        var table = $('#setting-table').DataTable({
            ...
            , buttons: [{
                ...
                ,
                 ...
                 {
                    text: '<i class="fas fa-plus-circle me-1"></i> إضافة مرحلة جديدة'
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="text-center mb-6">
                    <h4 class="mb-2">إضافة مرحلة جديدة</h4>
                    <p>عروض الاسعار</p>
                </div>
                <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}" method="POST">
                    ...
                    <div class="col-12 mb-4">
                        <label class="form-label" for="modalSettingName">اسم
                            المرحلة</label>
                        <input type="text" id="modalSettingName" name="name" class="form-control" placeholder="اسم المرحلة" required />
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback"> اسم المرحلة مطلوب
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-simple">
        <div class="modal-content">
            <div class="modal-body">
                <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="text-center mb-6">
                    <h4 class="mb-2">تعديل بيانات المرحلة </h4>
                    <p>
                        عروض الاسعار
                    </p>
                </div>
                <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                    ...
                    @method('PUT')
                    <div class="col-12 mb-4">
                        <label class="form-label" for="modalSettingNameEdit"> اسم المرحلة </label>
                        <input type="text" id="modalSettingNameEdit" name="name" class="form-control" placeholder="اسم  المرحلة " required />
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback">اسم المرحلة مطلوب</div>
                    </div>
                    <div class="col-12 text-center demo-vertical-spacing">
