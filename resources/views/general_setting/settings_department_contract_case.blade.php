...
@section('title', 'إعدادات اقسام المشاريع و القضايا')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات اقسام المشاريع و القضايا
        </a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات اقسام المشاريع و القضايا"
        ...
        $(document).ready(function() {
            ...
            var table = $('#setting-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: null, // استخدام null لأننا سنحسبها يدويًا
                        name: 'status',
                        className: 'text-center',
                        render: function(data, type, row) {
                            // حساب عدد department_contract_cases
                            // يجب أن تكون بيانات department_contract_cases متاحة في كل صف
                            return row.department_contract_cases ? row.department_contract_cases
                                .length : 0;
                        }
                    }, {
                        data: 'created_at',
                ...
                buttons: [{
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    confirmDeleteSelectedmss(
                                        selectedIds,
                                        "{{ route('mass.delete') }}",
                                        'SettingsDepartmentContractCase'
                    ...
                    {
                        text: '<i class="fas fa-plus-circle me-1"></i> إضافة قسم جديد',
                ...
                //     // إزالة فئة 'form-select-sm' وإضافة 'form-select'
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">إضافة قسم جديد</h4>
                        <p>اقسام المشاريع و القضايا و العقود</p>
                    </div>
                    <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}"
                        method="POST">
                        @csrf
                        ...
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingName">اسم
                                القسم</label>
                            <input type="text" id="modalSettingName" name="name" class="form-control"
                                placeholder="اسم القسم" required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback"> اسم القسم مطلوب
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="text-center mb-6">
                        <h4 class="mb-2">تعديل بيانات القسم</h4>
                        <p>اقسام المشاريع و القضايا و العقود</p>
                    </div>
                    <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                        ...
                        @method('PUT')
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingNameEdit">اسم القسم</label>
                            <input type="text" id="modalSettingNameEdit" name="name" class="form-control"
                                placeholder="اسم القسم" required />
                            <div class="valid-feedback"></div>
