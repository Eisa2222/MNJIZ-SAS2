...
@section('title', 'إعدادات انواع الاحكام ')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات انواع الاحكام</a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات انواع الاحكام" data-page-url="{{ url()->current() }}"
        ...
        var table = $('#setting-table').DataTable({
            ...
            , buttons: [{
                        ...
                        , {
                            ...
                            , action: function(e, dt, node, config) {
                                ...
                                confirmDeleteSelectedmss(selectedIds
                                    , "{{ route('mass.delete') }}", 'SettingsTypeRulings'
                ...
                ,
                 ...
                 {
                    text: '<i class="fas fa-plus-circle me-1"></i> إضافة نوع حكم  جديد'
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="text-center mb-6">
                    <h4 class="mb-2">إضافة نوع حكم جديد</h4>
                    <p> انواع الاحكام </p>
                </div>
                <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}" method="POST">
                    ...
                    <div class="col-12 mb-4">
                        <label class="form-label" for="modalSettingName">اسم
                            نوع الحكم </label>
                        <input type="text" id="modalSettingName" name="name" class="form-control" placeholder="اسم نوع الحكم " required />
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback"> اسم نوع الحكم مطلوب
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-simple">
        <div class="modal-content">
            <div class="modal-body">
                <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="text-center mb-6">
                    <h4 class="mb-2">تعديل بيانات نوع الحكم</h4>
                    <p>انواع الاحكام</p>
                </div>
                <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                    ...
                    @method('PUT')
                    <div class="col-12 mb-4">
                        <label class="form-label" for="modalSettingNameEdit"> نوع الحكم </label>
                        <input type="text" id="modalSettingNameEdit" name="name" class="form-control" placeholder="اسم نوع الحكم " required />
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback">اسم نوع الحكم مطلوب</div>
                    </div>
                    <div class="col-12 text-center demo-vertical-spacing">
