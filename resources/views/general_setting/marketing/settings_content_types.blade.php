...
@section('title', 'إعدادات أنواع الحملات و المحتوى ')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات أنواع الحملات و المحتوى 
        </a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات أنواع الحملات و المحتوى " data-page-url="{{ url()->current() }}"
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    confirmDeleteSelectedmss(selectedIds,
                                        "{{ route('mass.delete') }}", 'SettingsContentType'
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">إضافة نوع جديد</h4>
                        <p> أنواع الحملات و المحتوى</p>
                    </div>
                    <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}"
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div class="invalid-feedback"> اسم النوع مطلوب
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="text-center mb-6">
                        <h4 class="mb-2">تعديل بيانات النوع </h4>
                        <p> أنواع الحملات و المحتوى</p>
                    </div>
                    <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                        ...
                        @method('PUT')
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingNameEdit">اسم النوع</label>
                            <input type="text" id="modalSettingNameEdit" name="name" class="form-control"
                                placeholder="اسم النوع" required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">اسم النوع مطلوب</div>
                        </div>
                        <div class="col-12 text-center demo-vertical-spacing">
