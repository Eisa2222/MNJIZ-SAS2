...
@section('title', 'إعدادات أنماط النشر ')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات أنماط النشر 
        </a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات أنماط النشر " data-page-url="{{ url()->current() }}"
        ...
        $(document).ready(function() {
            ...
            var table = $('#setting-table').DataTable({
                ...
                buttons: [{
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    confirmDeleteSelectedmss(selectedIds,
                                        "{{ route('mass.delete') }}", 'SettingsPublishingPattern'
                    ...
                    {
                        text: '<i class="fas fa-plus-circle me-1"></i> إضافة نمط جديد',
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">إضافة نمط جديد</h4>
                        <p> أنماط النشر</p>
                    </div>
                    <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}"
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <input type="text" id="modalSettingName" name="name" class="form-control"
                                placeholder="اسم نمط النشر" required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback"> اسم نمط النشر مطلوب
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="text-center mb-6">
                        <h4 class="mb-2">تعديل بيانات نمط النشر </h4>
                        <p> أنماط النشر</p>
                    </div>
                    <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                        ...
                        @method('PUT')
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingNameEdit">اسم نمط النشر</label>
                            <input type="text" id="modalSettingNameEdit" name="name" class="form-control"
                                placeholder="اسم نمط النشر" required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">اسم نمط النشر مطلوب</div>
                        </div>
                        <div class="col-12 text-center demo-vertical-spacing">
