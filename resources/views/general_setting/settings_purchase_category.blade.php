...
@section('title', 'إعدادات تصنيف المشتريات')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات تصنيف المشتريات
        </a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات تصنيف المشتريات" data-page-url="{{ url()->current() }}"
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                        ...
                        @method('PUT')
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingNameEdit"> التصنيف</label>
                            <input type="text" id="modalSettingNameEdit" name="name" class="form-control"
                                placeholder="اسم  التصنيف " required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">اسم التصنيفمطلوب</div>
                        </div>
                        <div class="col-12 text-center demo-vertical-spacing">
