...
@section('title', 'إعدادات مرجعية الاصل')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات مرجعية الاصل
        </a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات مرجعية الاصل" data-page-url="{{ url()->current() }}"
        ...
        $(document).ready(function() {
            ...
            var table = $('#setting-table').DataTable({
                ...
                buttons: [{
                    ...
                    {
                        text: '<i class="fas fa-plus-circle me-1"></i> إضافة مرجع جديد',
...
@section('content')
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">إضافة مرجع جديد</h4>
                        <p> مرجعية الاصل</p>
                    </div>
                    <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}"
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <input type="text" id="modalSettingName" name="name" class="form-control"
                                placeholder="اسم المرجع " required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback"> اسم المرجع مطلوب
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="text-center mb-6">
                        <h4 class="mb-2">تعديل بيانات المرجع </h4>
                        <p> مرجعية الاصل </p>
                    </div>
                    <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                        ...
                        @method('PUT')
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingNameEdit">اسم المرجع </label>
                            <input type="text" id="modalSettingNameEdit" name="name" class="form-control"
                                placeholder="اسم المرجع " required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">اسم المرجع مطلوب</div>
                        </div>
                        <div class="col-12 text-center demo-vertical-spacing">
    ...
    <script>
        ...
        // التعامل مع تغيير المرجع عند النقر على الشارة
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        toastr.success('تم تغيير المرجع بنجاح.');
                    } else {
                        toastr.error('فشل في تغيير المرجع.');
                    }
                },
                error: function(xhr) {
                    toastr.error('حدث خطأ أثناء تغيير المرجع.');
                }
            });
        });
    </script>
