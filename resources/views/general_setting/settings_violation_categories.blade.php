...
@section('title', 'إعدادات تصنيف المخالفات')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات تصنيف المخالفات</a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات تصنيف المخالفات" data-page-url="{{ url()->current() }}"
                ...
                <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}" method="POST">
                    ...
                    <div class="col-12 mb-4">
                        <label class="form-label" for="modalSettingName">اسم
                            التصنيف </label>
                        <input type="text" id="modalSettingName" name="name" class="form-control" placeholder="اسم التصنيف " required />
            ...
            <div class="modal-body">
                ...
                <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <input type="text" id="modalSettingNameEdit" name="name" class="form-control" placeholder="اسم التصنيف " required />
                        <div class="valid-feedback"></div>
