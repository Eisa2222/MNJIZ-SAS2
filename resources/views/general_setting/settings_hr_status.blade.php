...
@section('title', 'إعدادات حالات الموارد البشرية ')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات حالات الموارد البشرية
        </a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات حالات الموارد البشرية"
            ...
            var table = $('#setting-table').DataTable({
                ...
                buttons: [{
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    confirmDeleteSelectedmss(selectedIds,
                                        "{{ route('mass.delete') }}", 'SettingsHrStatus'
...

                    {
                        ...
                        text: '<i class="fas fa-plus-circle me-1"></i> إضافة حالة موارد بشرية جديدة',
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">إضافة حالة موارد بشرية جديدة</h4>
                    ...
                    <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}"
                        ...
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingName">اسم
                                حالة الموارد البشرية </label>
                            <input type="text" id="modalSettingName" name="name" class="form-control"
                                placeholder="اسم حالة الموارد البشرية " required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback"> اسم حالة الموارد البشرية مطلوب
                            </div>
                        </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                        ...
                        @method('PUT')
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingNameEdit"> حالة الموارد البشرية </label>
                            <input type="text" id="modalSettingNameEdit" name="name" class="form-control"
                                placeholder="اسم  حالة الموارد البشرية  " required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">اسم حالة الموارد البشرية مطلوب</div>
                        </div>
                        <div class="col-12 text-center demo-vertical-spacing">
            ...
            <table id="setting-table" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>اسم حالة الموارد البشرية </th>
                        <th>الحالة</th>
                        <th>تاريخ الإضافة</th>
                        <th>الإجراءات</th>
                    </tr>
