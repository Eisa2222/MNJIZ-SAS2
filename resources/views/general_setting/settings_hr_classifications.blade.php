...
@section('title', 'إعدادات تصنيف الموارد البشرية')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات تصنيف الموارد البشرية
        </a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات تصنيف الموارد البشرية"
            ...
            var table = $('#setting-table').DataTable({
                ...
                buttons: [{
...

                    {
                        ...
                        text: '<i class="fas fa-plus-circle me-1"></i> إضافة مورد بشري جديد',
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">إضافة مورد جديد</h4>
                        <p> تصنيف الموارد البشرية</p>
                    </div>
                    <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}"
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div class="invalid-feedback"> اسم المورد مطلوب
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="text-center mb-6">
                        <h4 class="mb-2">تعديل بيانات المورد</h4>
                        <p> تصنيف الموارد البشرية</p>
                    </div>
                    <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                        ...
                        @method('PUT')
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingNameEdit">اسم المورد</label>
