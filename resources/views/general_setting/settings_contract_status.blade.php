...
@section('title', 'إعدادات حالات العقود و المشاريع')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات حالات العقود و المشاريع
        </a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات حالات العقود و العروض"
        ...
        $(document).ready(function() {
            ...
            var table = $('#setting-table').DataTable({
                ...
                buttons: [{
                    ...
                    {
                        text: '<i class="fas fa-plus-circle me-1"></i> إضافة حالة  جديدة',
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">إضافة حالة جديدة</h4>
                        <p> حالات العقود و المشاريع</p>
                    </div>
                    <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}"
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div class="invalid-feedback"> اسم الحالة مطلوب
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="text-center mb-6">
                        <h4 class="mb-2">تعديل بيانات الحالة </h4>
                        <p> حالات العقود و المشاريع </p>
                    </div>
                    <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                        ...
                        @method('PUT')
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingNameEdit">اسم الحالة </label>
                            <input type="text" id="modalSettingNameEdit" name="name" class="form-control"
                                placeholder="اسم الحالة " required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">اسم الحالة مطلوب</div>
                        </div>
                        <div class="col-12 text-center demo-vertical-spacing">
