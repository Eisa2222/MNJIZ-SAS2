...
@section('title', 'إعدادات درجة الجهة')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إعدادات درجة الجهة
        </a>
        <i class="ti ti-star favorite-icon" data-page-name="إعدادات درجة الجهة" data-page-url="{{ url()->current() }}"
        ...
        $(document).ready(function() {
            ...
            var table = $('#setting-table').DataTable({
                ...
                buttons: [{
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    confirmDeleteSelectedmss(selectedIds,
                                        "{{ route('mass.delete') }}", 'SettingsEntityRank'
                    ...
                    {
                        text: '<i class="fas fa-plus-circle me-1"></i> إضافة درجة جهة جديدة',
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">إضافة درجة جهة جديدة</h4>
                        <p> الجهات</p>
                    </div>
                    <form class="needs-validation row" novalidate id="" action="{{ route($route . '.store') }}"
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <input type="text" id="modalSettingName" name="name" class="form-control"
                                placeholder="اسم درجة الجهة" required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback"> اسم درجة الجهة مطلوب
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="text-center mb-6">
                        <h4 class="mb-2">تعديل بيانات درجة الجهة </h4>
                        <p> الجهات</p>
                    </div>
                    <form id="editSettingForm" class="needs-validation row" novalidate method="POST">
                        ...
                        @method('PUT')
                        <div class="col-12 mb-4">
                            <label class="form-label" for="modalSettingNameEdit">اسم درجة الجهة</label>
                            <input type="text" id="modalSettingNameEdit" name="name" class="form-control"
                                placeholder="اسم درجة الجهة" required />
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">اسم درجة الجهة مطلوب</div>
                        </div>
                        <div class="col-12 text-center demo-vertical-spacing">
