<div class="col app-chat-history bg-body">
        ...
        <div class="chat-history-wrapper">
            ...
            <div class="chat-history-body">
                <ul class="list-unstyled chat-history m-0" id="messages-container">
                    ...
                    @empty
                        @include('legal-ai.precedents.partials.welcome-message')
                    @endforelse
                </ul>
            </div>

            <div class="chat-history-footer shadow-sm">
                <form id="precedent-search-form" class="form-send-message p-3" onsubmit="return false;">
                    @csrf
                    <div class="d-flex align-items-center">
                        <textarea class="form-control message-input border-0 me-3 shadow-none"
                            placeholder="اكتب وصفًا للواقعة أو سؤالاً عن سابقة قضائية..." id="query-input" name="query_text" rows="1"></textarea>

                        <label for="document-input" class="btn btn-icon btn-label-primary flex-shrink-0"
                            title="إرفاق مستند للتحليل">
                            <i class="ti ti-paperclip ti-18px"></i>
                        </label>
                        <input type="file" id="document-input" name="document" class="d-none"
                            accept=".pdf,.doc,.docx,.txt">

                        <button type="submit" id="start-search-btn" class="btn btn-primary d-flex ms-2 send-msg-btn">
                            <i class="ti ti-search ti-16px me-md-2 me-0"></i>
                            <span class="align-middle d-md-inline-block d-none">بحث</span>
    ...
    @else
        <div class="d-flex justify-content-center align-items-center h-100 flex-column text-center">
            <i class="ti ti-gavel ti-4x mb-3 text-primary"></i>
            <h4>السوابق القضائية</h4>
            <p class="text-muted">اختر بحثًا سابقًا أو ابدأ واحدًا جديدًا.</p>
        </div>
    @endif
