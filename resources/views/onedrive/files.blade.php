                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card p-2 h-100 shadow-none border">
                            ...
                            <div class="card-body p-4 pt-2">
                                ...
                                <a href="{{ url('app/academy/course-details') }}" class="h5">{{ $file['name'] }}</a>
                                <p class="mt-1">Introductory course for Angular and framework basics in web development.
                                </p>
                                ...
                                <div
                                    ...
                                    <a class="w-100 btn btn-label-secondary d-flex align-items-center"
                                        href="{{ url('app/academy/course-details') }}">
                                        <i class="ti ti-rotate-clockwise-2 ti-xs align-middle scaleX-n1-rtl me-2"></i><span>Start
                                            Over</span>
                                    </a>
                ...
                <div class="col-sm-12 col-lg-4 text-center pt-md-12 px-4">
                    <div class="d-flex justify-content-center">
                        <div class="avatar avatar-lg mb-4">
                            <span class="avatar-initial rounded bg-label-primary h-px-52 w-px-52"><i
                                    class="ti ti-gift ti-36px"></i></span>
                        </div>
                    </div>
                    <h4 class="card-title mb-4">Today's Free Courses</h4>
                    <p class="card-text">
                        We offers 284 Free Online courses from top tutors and companies to help you start or advance your
                        career
