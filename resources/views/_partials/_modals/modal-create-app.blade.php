                        ...
                        <form onSubmit="return false">
                                ...
                                <ul class="p-0 m-0">
                                    <li class="d-flex align-items-start mb-4">
                                        <div class="badge bg-label-info p-2 me-3 rounded"><i
                                                class="ti ti-file-text ti-30px"></i></div>
                                    ...
                                    <li class="d-flex align-items-start mb-4">
                                        <div class="badge bg-label-success p-2 me-3 rounded"><i
                                                class="ti ti-shopping-cart ti-30px"></i></div>
                                        <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                            <div class="me-2">
                                    ...
                                    <li class="d-flex align-items-start">
                                        <div class="badge bg-label-danger p-2 me-3 rounded"><i
                                                class="ti ti-device-laptop ti-30px"></i></div>
                                        <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                            <div class="me-2">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-check form-check-inline">
                                                    <input name="details-radio" class="form-check-input"
                                                        type="radio" value="" />
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div id="frameworks" class="content pt-4 pt-lg-0">
                                ...
                                <ul class="p-0 m-0">
                                    <li class="d-flex align-items-start mb-4">
                                        <div class="badge bg-label-info p-2 me-3 rounded"><i
                                                class="ti ti-brand-react-native ti-30px"></i></div>
                                        <div class="d-flex justify-content-between w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-check form-check-inline">
                                                    <input name="frameworks-radio" class="form-check-input"
                                                        type="radio" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="d-flex align-items-start mb-4">
                                        <div class="badge bg-label-danger p-2 me-3 rounded"><i
                                                class="ti ti-brand-angular ti-30px"></i></div>
                                        <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                            <div class="me-2">
                                    ...
                                    <li class="d-flex align-items-start mb-4">
                                        <div class="badge bg-label-warning p-2 me-3 rounded"><i
                                                class="ti ti-brand-html5 ti-30px"></i></div>
                                        <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                            <div class="me-2">
                                    ...
                                    <li class="d-flex align-items-start">
                                        <div class="badge bg-label-success p-2 me-3 rounded"><i
                                                class="ti ti-brand-vue ti-30px"></i></div>
                                        <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                            <div class="me-2">
                            ...
                            <div id="database" class="content pt-4 pt-lg-0">
                                ...
                                <ul class="p-0 m-0">
                                    <li class="d-flex align-items-start mb-4">
                                        <div class="badge bg-label-danger p-2 me-3 rounded"><i
                                                class="ti ti-brand-firebase ti-30px"></i></div>
                                        <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                            <div class="me-2">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-check form-check-inline">
                                                    <input name="database-radio" class="form-check-input"
                                                        type="radio" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="d-flex align-items-start mb-4">
                                        <div class="badge bg-label-warning p-2 me-3 rounded"><i
                                                class="ti ti-brand-amazon ti-30px"></i></div>
                                        <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                            <div class="me-2">
                                    ...
                                    <li class="d-flex align-items-start">
                                        <div class="badge bg-label-info p-2 me-3 rounded"><i
                                                class="ti ti-database ti-30px"></i></div>
                                        <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                            <div class="me-2">
                                ...
                                <div id="AppNewCCForm" class="row g-6 pt-3 pt-lg-0 mb-6" onsubmit="return false">
                                    ...
                                    <div class="col-6 col-md-3">
                                        ...
                                        <input type="text" class="form-control app-expiry-date-mask"
                                            placeholder="MM/YY" id="modalAppExpiry" />
                                    </div>
                                    <div class="col-6 col-md-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-switch">
                                            ...
                                            <label for="appFutureAddress" class="form-label">Save card for future
                                                billing?</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="submit" class="content text-center pt-4 pt-lg-0">
                                ...
                                <!-- image -->
                                <img src="{{ asset('assets/shared/img/illustrations/girl-with-laptop.png') }}"
                                    class="img-fluid" alt="Create App img" width="175">
                                <div class="col-12 d-flex justify-content-between mt-6">
                                    <button class="btn btn-label-secondary btn-prev"> <i
                                            class="ti ti-arrow-left ti-xs me-sm-2 me-0"></i> <span
                                            class="align-middle d-sm-inline-block d-none">Previous</span> </button>
                                    <button class="btn btn-success btn-next btn-submit" data-bs-dismiss="modal"
                                        aria-label="Close"> <span class="align-middle">Submit</span></button>
                                </div>
                            </div>
                        </form>
                    </div>
