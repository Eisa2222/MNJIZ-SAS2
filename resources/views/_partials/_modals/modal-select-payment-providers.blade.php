            ...
            <div class="modal-body">
                ...
                <div
                    ...
                    <div class="d-flex flex-wrap gap-4">
                        <img src="{{ asset('assets/shared/img/icons/payments/visa-' . $configData['style'] . '.png') }}"
                        ...
                        <img src="{{ asset('assets/shared/img/icons/payments/master-' . $configData['style'] . '.png') }}"
                        ...
                        <img src="{{ asset('assets/shared/img/icons/payments/ae-' . $configData['style'] . '.png') }}"
                        ...
                        <img src="{{ asset('assets/shared/img/icons/payments/jcb-' . $configData['style'] . '.png') }}"
                        ...
                        <img src="{{ asset('assets/shared/img/icons/payments/dc-' . $configData['style'] . '.png') }}"
