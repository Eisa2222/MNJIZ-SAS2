                            ...
                            <div class="card border rounded shadow-none">
                                <div class="card-body pt-12">
                                    <div class="mt-3 mb-5 text-center">
                                        <img src="{{ asset('assets/shared/img/illustrations/page-pricing-basic.png') }}"
                            ...
                            <div class="card border-primary border shadow-none">
                                <div class="card-body position-relative pt-4">
                                    ...
                                    <div class="my-5 pt-6 text-center">
                                        <img src="{{ asset('assets/shared/img/illustrations/page-pricing-standard.png') }}"
                        ...
                        <div class="col-xl">
                            <div class="card border rounded shadow-none">
                                <div class="card-body pt-12">
                                    ...
                                    <div class="mt-3 mb-5 text-center">
                                        <img src="{{ asset('assets/shared/img/illustrations/page-pricing-enterprise.png') }}"
