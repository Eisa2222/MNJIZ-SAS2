        ...
        <div class="modal-content">
            ...
            <div class="mb-6 mx-4 mx-md-0">
                ...
                <select id="select2Basic" class="form-select form-select-lg share-project-select"
                    ...
                    <option data-name="Adelaide Nichols" data-image="img/avatars/13.png" selected>Adelaide Nichols
                    </option>
            ...
            <ul class="p-0 m-0 mx-4 mx-md-0">
                <li class="d-flex flex-wrap mb-4">
                    <div class="avatar me-4">
                        <img src="{{ asset('assets/shared/img/avatars/1.png') }}" alt="avatar" class="rounded-circle">
                    </div>
                ...
                <li class="d-flex flex-wrap mb-4">
                    <div class="avatar me-4">
                        <img src="{{ asset('assets/shared/img/avatars/2.png') }}" alt="avatar" class="rounded-circle">
                    </div>
                    <div class="d-flex justify-content-between flex-grow-1">
                        <div class="me-2">
                        ...
                        <div class="dropdown">
                            <button type="button" class="btn btn-text-secondary dropdown-toggle p-2 text-secondary"
                                data-bs-toggle="dropdown" aria-expanded="false"><span
                                    class="me-2 d-none d-sm-inline-block">Owner</span></button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0);">Owner</a>
                                </li>
                ...
                <li class="d-flex flex-wrap mb-4">
                    <div class="avatar me-4">
                        <img src="{{ asset('assets/shared/img/avatars/3.png') }}" alt="avatar" class="rounded-circle">
                    </div>
                    <div class="d-flex justify-content-between flex-grow-1">
                        <div class="me-2">
                ...
                <li class="d-flex flex-wrap mb-4">
                    <div class="avatar me-4">
                        <img src="{{ asset('assets/shared/img/avatars/4.png') }}" alt="avatar"
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                        ...
                        <div class="dropdown">
                            <button type="button" class="btn btn-text-secondary dropdown-toggle p-2 text-secondary"
                                data-bs-toggle="dropdown" aria-expanded="false"><span
                                    class="me-2 d-none d-sm-inline-block">Can Comment</span> </button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0);">Owner</a>
                                </li>
                ...
                <li class="d-flex flex-wrap mb-4">
                    <div class="avatar me-4">
                        <img src="{{ asset('assets/shared/img/avatars/5.png') }}" alt="avatar"
                            class="rounded-circle">
                    </div>
                    <div class="d-flex justify-content-between flex-grow-1">
                        <div class="me-2">
                ...
                <li class="d-flex flex-wrap mb-4">
                    <div class="avatar me-4">
                        <img src="{{ asset('assets/shared/img/avatars/6.png') }}" alt="avatar"
                            class="rounded-circle">
                    </div>
                    <div class="d-flex justify-content-between flex-grow-1">
                        <div class="me-2">
                ...
                <li class="d-flex flex-wrap mb-4">
                    <div class="avatar me-4">
                        <img src="{{ asset('assets/shared/img/avatars/7.png') }}" alt="avatar"
                            class="rounded-circle">
                    </div>
                    <div class="d-flex justify-content-between flex-grow-1">
                        <div class="me-2">
                ...
                <li class="d-flex flex-wrap">
                    <div class="avatar me-4">
                        <img src="{{ asset('assets/shared/img/avatars/8.png') }}" alt="avatar"
                            class="rounded-circle">
                    </div>
                    <div class="d-flex justify-content-between flex-grow-1">
                        <div class="me-2">
