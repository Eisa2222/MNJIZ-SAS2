    ...
    @section('title', 'كل المهام')

    @section('breadcrumb')
        <li><a href="#">مركز تنظيم الاعمال</a></li>
        <li class="breadcrumb-item d-flex align-items-center">
            <a href="#">كل المهام</a>
            <i class="ti ti-star favorite-icon" data-page-name="كل المهام" data-page-url="{{ url()->current() }}"
    ...
    @section('vendor-script')
        ...
        {!! $dataTable->scripts() !!}
        @vite(['resources/assets/js/organization-center/tasks/tasks-datatable.js', 'resources/assets/js/organization-center/tasks/filter.js'])
    @endsection
            ...
            <div class="card-body">
                <div class="filters row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="filter-employee" class="form-control select2" data-placeholder="اختر  مسؤول ">
                            <option value=""></option>
