    ...
    @section('title', 'مهام مسندة للأخرين')

    @section('breadcrumb')
        <li><a href="#">مركز تنظيم الاعمال</a></li>
        <li class="breadcrumb-item d-flex align-items-center">
            <a href="#">مهام مسندة للأخرين</a>
            <i class="ti ti-star favorite-icon" data-page-name="مهام مسندة للأخرين" data-page-url="{{ url()->current() }}"
