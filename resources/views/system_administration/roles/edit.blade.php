...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#">تعديل الدور</a>
        <i class="ti ti-star favorite-icon" data-page-name="تعديل الدور" data-page-url="{{ url()->current() }}"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="form-check mb-2">
                                                                <input type="checkbox"
                                                                    ...
                                                                    {{ $perms->every(function ($perm) use ($role) {
                                                                        return $role->hasPermissionTo($perm->name);
                                                                    })
                                                                        ? 'checked'
                                                                        : '' }}>
