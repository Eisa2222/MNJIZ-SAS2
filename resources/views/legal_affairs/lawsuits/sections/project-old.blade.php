...
@section('sections')
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td class="pe-0 text-nowrap">
                                <h6 class="mb-0">{{ $project->contract->contract_name ?? 'العقد غير متاح حالياً' }}</h6>
                            </td>
                        </tr>
                        <!-- مدير المشروع -->
                        <tr>
                            ...
                            <td class="pe-0">
                                <h6 class="mb-0">{{ $project->manager_user->name ?? 'لم يتم تعيين المدير بعد' }}</h6>
                            </td>
                        </tr>
                        <!-- تاريخ البدء -->
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="pe-0">
                                <h6 class="mb-0">
                                    {{ $project->contractual_closure ? $project->contractual_closure : 'لا يوجد' }}</h6>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="pe-0">
                                <h6 class="mb-0">{{ $project->start_user ? $project->start_user->name : 'لا يوجد' }}</h6>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="pe-0">
                                <h6 class="mb-0">
                                    {{ $project->complate_user ? $project->complate_user->name : 'لا يوجد' }}
                                </h6>
        ...
        <div class="card h-100 d-flex flex-column">
                    ...
                    <div class="info-container">
                        <ul class="list-unstyled my-3">
                            ...
                            <li class="d-flex align-items-center mb-3"><i class="ti ti-language ti-lg"></i><span
                                    class="fw-medium mx-2">البريد الإلكتروني:</span>
                            ...
                            <li class="d-flex align-items-center mb-3"><i class="ti ti-phone ti-lg"></i><span
                                    class="fw-medium mx-2">رقم الجوال:</span>
                                <span>{{ $project->manager_user->employee->mobile ?? 'غير متوفر' }}</span>
                            </li>
                        </ul>

                        <div class="d-grid gap-2">
                            <a href="mailto:{{ $project->manager_user->employee->work_email }}" class="btn btn-primary">
                                <i class="ti ti-mail me-1"></i> التواصل عبر البريد الإلكتروني
                            </a>
                            @if ($project->manager_user->employee->mobile)
                                <a href="tel:{{ $project->manager_user->employee->mobile }}" class="btn btn-success">
            ...
            @else
                <div class="card-body text-center">
                    <img class="img-fluid rounded mb-4" src="{{ asset('assets/img/avatars/default-placeholder.png') }}"
                        height="120" width="120" alt="No Manager Assigned" />
    ...
    <div class="mt-5">
        <h5 class="mb-3">فريق المشروع</h5>
        @if ($project->teamMembers->isNotEmpty())
            <table class="table table-bordered table-striped table-sm w-100">
                <thead>
                    <tr>
                        <th scope="col" style="width: 5%;">م</th>
                        <th scope="col" style="width: 25%;">اسم الموظف</th>
                        <th scope="col" style="width: 15%;">المسمى الوظيفي</th>
                        <th scope="col" style="width: 20%;">البريد الإلكتروني</th>
                        <th scope="col" style="width: 15%;">رقم الجوال</th>
                        <th scope="col" style="width: 20%;"> تاريخ الاضافة للفريق</th>
                ...
                <tbody>
                    @foreach ($project->teamMembers as $index => $member)
                        <tr>
                            ...
                            <td class="align-middle">
                                <div class="d-flex align-items-center">
                                    <img src="{{ $member->profile_picture ? Storage::url($member->profile_picture) : asset('assets/img/branding/Alburhan-Logo.png') }}"
                                        alt="صورة الموظف" width="40" height="40" class="rounded-circle me-3">
                            ...
                            <!-- البريد الإلكتروني -->
                            <td class="align-middle">
                                <a href="mailto:{{ $member->work_email }}" class="text-decoration-none text-primary">
                                    {{ $member->work_email }}
                                </a>
                            </td>
                            ...
                            <!-- رقم الجوال -->
                            <td class="align-middle">
                                {{ $member->mobile ?? 'غير متوفر' }}
                            </td>
                            <!-- تاريخ الإضافة للفريق بالهجري -->
                            <td class="align-middle">
                                {{ Alkoumi\LaravelHijriDate\Hijri::Date('Y-m-d', Carbon\Carbon::parse($member->pivot->created_at)->format('Y-m-d')) }}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
