            ...
            <div class="card card-action mb-6">
                <div class="card-header align-items-center border-bottom mb-5">
                    <h5 class="card-action-title mb-0 text-primary fw-bold">
                        <i class="ti ti-video  ti-lg text-body me-3 text-primary fw-bold"></i> الإجتماعات الخاصة بالدعاوى
                        <span class="small text-muted">ستظهر هنا جميع الاجتماعات الخاصة بالدعاوى التي تم عقدها</span>
                    </h5>
                </div>
