...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item d-flex align-items-center"><a href="#">إضافة وكالة جديدة</a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة وكالة جديدة" data-page-url="{{ url()->current() }}"
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    @endif
                    <form id="power-form" action="{{ route('legal-affairs.power-attorney.store') }}" method="POST"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="power_number" name="power_number" class="form-control"
                                        value="{{ old('power_number') }}" required />
                                </div>
                                    ...
                                    <select id="customers" name="customers[]" class="w-100 select2" data-style="btn-default"
                                        ...
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}"
                                                ...
                                                {{ collect(old('customers'))->contains($customer->id) ? 'selected' : '' }}>
                                                {{ $customer->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select multiple id="agents" name="agents[]" class="w-100 select2"
                                        data-style="btn-default" required multiple data-actions-box="true"
                                        data-live-search="true" data-placeholder="اختر الوكلاء">
                                        @foreach ($employees as $employee)
                                            <option value="{{ $employee->id }}"
                                                {{ collect(old('agents'))->contains($employee->id) ? 'selected' : '' }}>
                                                {{ $employee->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6" style="position: relative">
                                    ...
                                    <input type="text" id="date_issued" name="date_issued"
                                        class="form-control hijri-picker" value="{{ old('date_issued') }}" required
                                ...
                                <div class="col-md-6" style="position: relative">
                                    ...
                                    <input type="text" id="date_expiry" name="date_expiry"
                                        class="form-control hijri-picker" value="{{ old('date_expiry') }}"
                                        autocomplete="off" onkeydown="return false;" />
                                </div>
                            </div>
