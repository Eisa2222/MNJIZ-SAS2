...
@section('breadcrumb')
    <li><a href="{{ route('supports.index') }}">الدعم الفني </a></li>
...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <button class="btn btn-primary d-grid w-100 mb-4" data-bs-toggle="offcanvas"
                        ...
                        <span class="d-flex align-items-center justify-content-center text-nowrap">اضافة رد <i
                                class="ti ti-send ti-xs mx-2"></i></span>
                    </button>
    ...
    <!-- Offcanvas -->
    @include('supports/_partials/add_reply')
    @include('supports/_partials/user_replies')
    <!-- /Offcanvas -->
@endsection
