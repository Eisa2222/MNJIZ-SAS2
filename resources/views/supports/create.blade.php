                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="ticket-classification" name="ticket_classification"
                                            class="form-select @error('ticket_classification') is-invalid @enderror"
                                            required>
                                            <option value="" disabled {{ old('ticket_classification') ? '' : 'selected'
                                                }}>اختر تصنيف التذكرة</option>
                                            <option value="اقتراح" {{ old('ticket_classification')=='اقتراح'
                                                ? 'selected' : '' }}>اقتراح</option>
                                            <option value="شكوى" {{ old('ticket_classification')=='شكوى' ? 'selected'
                                                : '' }}>شكوى</option>
                                            <option value="تعديلات برمجية" {{ old('ticket_classification')=='تعديلات برمجية'
                                                ? 'selected' : '' }}>تعديلات برمجية</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="priority" name="priority"
                                            ...
                                            <option value="" disabled {{ old('priority') ? '' : 'selected' }}>اختر
                                                الأولوية</option>
                                            <option value="عاجلة" {{ old('priority')=='عاجلة' ? 'selected' : '' }}>عاجلة
                                            </option>
                                            <option value="عالية" {{ old('priority')=='عالية' ? 'selected' : '' }}>عالية
                                            </option>
                                            <option value="متوسطة" {{ old('priority')=='متوسطة' ? 'selected' : '' }}>
                                                متوسطة</option>
                                            <option value="منخفضة" {{ old('priority')=='منخفضة' ? 'selected' : '' }}>
                                                منخفضة</option>
                                        </select>
                                        @error('priority')
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea id="description" name="notes" required
                                            ...
                                            placeholder="أضف الوصف هنا">{{ old('notes') }}</textarea>
                                        @error('notes')
                                    ...
                                    <!-- المرفقات -->
                                    <div class="col-12">
                                        <label class="form-label" for="attachment">مرفق</label>
