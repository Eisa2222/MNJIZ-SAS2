...
@section('page-script')
    ...
    @vite(['resources/assets/js/electronic-services/custody_requests_wizard.js', 'resources/assets/js/electronic-services/custody/update-assign.js'])
@endsection
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    <form id="form"
                        action="{{ route('account.electronic-services.custody-requests.assign.update', $custody_request->id) }}"
