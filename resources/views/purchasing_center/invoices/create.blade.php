...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إضافة مشتريات </a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة مشتريات " data-page-url="{{ url()->current() }}"
...
@section('content')
    <div class="row invoice-add">
        ...
        <form id="invoiceForm" action="{{ route('purchasing-center.purchase-requests.invoices.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!-- إضافة فاتورة -->
                                        ...
                                        <div class="d-flex border rounded position-relative pe-0">
                                            <div class="row w-100 p-6">
                                                ...
                                                <div class="col-md-12 col-12 mb-md-0 mb-4">
                                                    ...
                                                    <textarea name="item_description" id="item_description" rows="2" class="form-control"
                                                    placeholder="  تفاصيل أو ملاحظات حول هذا العنصر"></textarea>
                                                </div>
                                            </div>
                                            <div
                ...
                <div class="col-lg-3 col-12 invoice-actions">
                    <div class="card mb-6">
                        <div class="card-body">
                            ...
                            <!-- زر المعاينة الذي يقوم بتغيير مسار النموذج وإرساله -->
                            {{-- <button type="button" id="previewButton" class="btn btn-label-secondary d-grid w-100 mb-4">
                                معاينة
                            </button> --}}
                        </div>
                    </div>
