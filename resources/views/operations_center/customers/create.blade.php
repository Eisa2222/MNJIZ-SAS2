...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item d-flex align-items-center"><a href="#">إضافة عميل جديد
        </a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة عميل جديد" data-page-url="{{ url()->current() }}"
        ...
        <div class="col-12 mb-6">
            <div id="wizard-validation" class="bs-stepper mt-2">
                    ...
                    <div class="step" data-target="#account-details-validation">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label mt-1">
                                ...
                                <span class="bs-stepper-subtitle">إدخال معلومات العميل الأساسية</span>
                            </span>
                        </button>
                    </div>
                    <div class="line">
                    ...
                    <div class="step" data-target="#social-links-validation">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label">
                                ...
                                <span class="bs-stepper-subtitle">إضافة معلومات إضافية</span>
                            </span>
                        </button>
                    </div>
                </div>
                <div class="bs-stepper-content">
                    ...
                    @endif
                    <form id="wizard-validation-form" action="{{ route('operations-center.customers.store') }}"
                                        ...
                                        <div class="form-check custom-option custom-option-icon">
                                            <label class="form-check-label custom-option-content" for="company">
                                                ...
                                                <input id="company" name="customer_type" class="form-check-input"
                                                    type="radio"
                                                    {{ old('customer_type', 'company') == 'company' ? 'checked' : '' }}
                                                    value="company">
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <select id="department_id" name="department_id" class="form-select select2"
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                {{ old('department_id') == $category->id ? 'selected' : '' }}>
                            ...
                            <div class="row g-3">
                                    ...
                                    <select class="select2 form-select" id="address" name="address"
                                        ...
                                        @foreach ($regions as $region)
                                            <option value="{{ $region->id }}"
                                                {{ old('address') == $region->id ? 'selected' : '' }}>
                                                {{ $region->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-6" id="civil-registry-field">
                                    ...
                                    <input type="text" name="civil_registry_number" minlength="10" maxlength="10"
                                        ...
                                        placeholder="ادخل السجل المدني " value="{{ old('civil_registry_number') }}" />
                                </div>
                                    ...
                                    <select class="select2 form-select" id="relationship_manager_id"
                                        ...
                                        @foreach ($employees as $employee)
                                            <option value="{{ $employee->id }}"
                                                {{ old('relationship_manager_id') == $employee->id ? 'selected' : '' }}>
                                    ...
                                    <select class="select2 form-select" id="marketing_channel_id"
                                        ...
                                        @foreach ($marketingChannels as $channel)
                                            <option value="{{ $channel->id }}"
                                                {{ old('marketing_channel_id') == $channel->id ? 'selected' : '' }}>
                                                {{ $channel->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="select2 form-select" id="parent_customer_id" name="parent_customer_id"
                                        ...
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}"
                                                {{ old('parent_customer_id') == $customer->id ? 'selected' : '' }}>
                                                {{ $customer->name }}
                                            </option>
                                        @endforeach
                                    </select>
