    ...
    @section('breadcrumb')
        ...
        <li class="breadcrumb-item d-flex align-items-center"><a href="#"> العروض</a>
            <i class="ti ti-star favorite-icon" data-page-name="العروض" data-page-url="{{ url()->current() }}"
    ...
    @section('page-script')
        @vite(['resources/assets/js/operations-center/offer/offer.js'])
    @endsection
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                ...
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="mb-0 me-2">{{ $pendingOffers }}</h4>
                                </div>
                                <small class="mb-0"> إجمالي العروض الجديدة </small>
                            </div>
                            <div class="avatar">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                ...
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="mb-0 me-2">{{ $approvedOffers }}</h4>
                                </div>
                                <small class="mb-0"> إجمالي العروض المعتمدة</small>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                ...
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="mb-0 me-2">{{ $rejectedOffers }}</h4>
                                </div>
                                <small class="mb-0"> إجمالي العروض المرفوضة</small>
                            </div>
                            <div class="avatar">
        ...
        <div class="card">
            <div class="card-body">
                <div class="filters row g-3">
                    <div class="col-md-4">
                        <label for="filter-status">حالة العرض</label>
                        <select id="filter-status" name="status" class="form-control select2"
                            data-placeholder="اختر حالة العرض">
                            <option value=""></option>
