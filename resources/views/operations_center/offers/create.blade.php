...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item d-flex align-items-center"><a href="#"> إضافة عرض جديد</a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة عرض جديد" data-page-url="{{ url()->current() }}"
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    @endif
                    <form id="power-form" action="{{ route('operations-center.offers.store') }}" method="POST"
                        ...
                        <div id="basic-info" class="content  dstepper-block">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="relationship_manage" class="form-label">
                                        مسؤول العلاقات
                                    ...
                                    <select id="relationship_manage" name="relationship_manage" class="form-select select2"
                                        disabled data-placeholder=" مسؤول العلاقات">
                                        <option value=""></option>
                                    </select>
                                </div>
                                <div class="col-md-6" style="position: relative">
                                    ...
                                    <input type="text" id="start_date" name="start_date"
                                        class="form-control hijri-picker" value="{{ old('start_date') }}" required
                        ...
                        <div id="additional-info-2" class="content">
                            <div class="row g-6">
                                <!-- نطاق العمل -->
                                <p class="text-danger">كل البيانات الموجودة هنا ( العرض الفني، العرض المالي
                                    ) هي افتراضية ويمكنك تعديلها أو حذفها نهائيًا. سيتم الاستفادة من هذه
                                    البيانات في العرض النهائي.</p>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="editor-technical-offer" style="height: 300px;">
                                        {!! old(
                                            'technical_offer',
                                            '<p><strong>العرض الفني</strong></p>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <p>القيام بتنفيذ نطاق العمل التالي:</p>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <ol>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <li data-list="ordered"><span class="ql-ui" contenteditable="false"></span>دراسة
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    المستندات والوثائق اللازمة.</li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <li data-list="ordered"><span class="ql-ui" contenteditable="false"></span>فتح
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    مؤسسة تجارية باسم الرئيس التنفيذي لفرع الشركة المسجل باسمه العقار.</li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <li data-list="ordered"><span class="ql-ui" contenteditable="false"></span>إفراغ
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    العقار باسم المؤسسة دون أن يكون هناك ضريبة التصرفات العقارية.</li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <li data-list="ordered"><span class="ql-ui"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        contenteditable="false"></span>إجراءات استحواذ شركة المتحدة للسيارات
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    والمعدات الثقيلة على المؤسسة مالكة العقار وجعلها فرعاً ثانياً للشركة
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    الخليجية.</li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <li data-list="ordered"><span class="ql-ui" contenteditable="false"></span>إنهاء
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    كل ما يتعلق بمراجعات وزارة التجارة بشأن الفرع الجديد.</li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <li data-list="ordered"><span class="ql-ui" contenteditable="false"></span>تمثيل
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    الشركة في جميع الجهات الحكومية ذات الاختصاص حتى اكتمال الاستحواذ، مع ضمان أن
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    يكون العقار ضمن أملاك الشركة الخليجية، دون أن يكون هناك ضريبة التصرفات
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    العقارية.</li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        </ol>',
                                        ) !!}
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="editor-financial-offer" style="height: 300px;">
                                        {!! old(
                                            'financial_offer',
                                            '<p><strong>العرض المالي</strong></p>
                                                                                                                                                                                                                                                                                                                                <p>قيمة أتعاب تنفيذ نطاق العمل الوارد في العرض الفني:</p>
                                                                                                                                                                                                                                                                                                                        <ol>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <li data-list="ordered"><span class="ql-ui" contenteditable="false"></span>دفعة
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    مقدمة بمبلغ وقدرة (120,000) [مئة وعشرون ألف ريال] تُدفع عند توقيع العقد</li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <li data-list="ordered"><span class="ql-ui" contenteditable="false"></span>مبلغ
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    وقدره 100,000 ريال تدفع عن انتهاء كامل الإجراءات.</li>
                                                                                                                                                                                                                                                                                                                        </ol>',
                                        ) !!}
                                    </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data) {
                                ...
                                $('#relationship_manage').empty();
                                $('#relationship_manage').append(
                                    '<option value="">اختر مسؤول العلاقات</option>');
                                $('#relationship_manage').append('<option selected>' + data
                                    .name + '</option>');
                            }
                        },
                        error: function() {
                            $('#relationship_manage').empty();
                            $('#relationship_manage').append(
                                '<option value="">لا يوجد مسؤول علاقات</option>');
                        }
                    });
                } else {
                    $('#relationship_manage').empty();
                    $('#relationship_manage').append('<option value="">اختر العميل أولاً</option>');
                }
            });
        });
    </script>
