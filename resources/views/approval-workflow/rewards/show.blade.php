...
@section('title', 'اعتماد مكافأة - ' . ($item->employee->name ?? 'غير محدد'))

@section('breadcrumb')
<li class="breadcrumb-item d-flex align-items-center">
    <a href="#">تفاصيل طلب {{ Str::limit($item->employee->name ?? 'غير محدد', 25) }}</a>
    <i class="ti ti-star favorite-icon" data-page-name="اعتماد مكافأة" data-page-url="{{ url()->current() }}"
...
'resources/assets/js/approval-workflow/approval-manager.js', 'resources/assets/js/approval-workflow/rewards/show.js'])
...
@section('content')
<!-- ============================================================== -->
<!-- القسم العلوي: تفاصيل الطلب ومراحل الاعتماد                    -->
<!-- ============================================================== -->
<div class="row g-3 align-items-stretch">

    <!-- العمود الأيمن: تفاصيل طلب المكافأة -->
                ...
                <div class="table-responsive rounded-3 border">
                    <table class="table table-striped table-hover mb-0">
                        <tbody>
                            ...
                            <tr>
                                <td class="fw-bold text-muted py-3 ps-4 pe-3 bg-light">نوع المكافأة</td>
                                <td class="py-3 ps-3 pe-4 fw-semibold text-dark">
                                    {{ $item->reward_type?->label() ?? 'غير محدد' }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="py-3 ps-3 pe-4 fw-semibold text-dark">
                                    {{ $item->reward_date?->format('d/m/Y') }}</td>
                            </tr>
                            @if ($item->notes)
                            <tr>
...
<!-- ============================================================== -->
<!-- القسم السفلي: سجل الاعتمادات (تصميم مطابق)                     -->
<!-- ============================================================== -->
<div class="row mt-4">
    <div class="col-12">
        <div class="card">
