...
@section('title', 'اعتماد سلفة - ' . ($item->employee->name ?? 'غير محدد'))

@section('breadcrumb')
<li class="breadcrumb-item d-flex align-items-center">
    <a href="#">تفاصيل طلب {{ Str::limit($item->employee->name ?? 'غير محدد', 25) }}</a>
    <i class="ti ti-star favorite-icon" data-page-name="اعتماد سلفة" data-page-url="{{ url()->current() }}"
...
'resources/assets/js/approval-workflow/approval-manager.js', 'resources/assets/js/approval-workflow/advances/show.js'])
...
<div class="row g-3 align-items-stretch">
    ...
    <div class="col-12 col-md-8 d-flex">
        <div class="card flex-fill d-flex flex-column h-100">
            ...
            <div class="card-body flex-fill overflow-auto">
                {{-- استخدام تصميم الجدول لعرض التفاصيل بشكل منظم --}}
                <div class="table-responsive rounded-3 border">
                    <table class="table table-striped table-hover mb-0">
                        <tbody>
                            ...
                            <tr>
                                <td class="fw-bold text-muted py-3 ps-4 pe-3 bg-light">نوع السلفة</td>
                                <td class="py-3 ps-3 pe-4 fw-semibold text-dark">
                                    {{ $item->advance_type?->label() ?? 'غير محدد' }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="py-3 ps-3 pe-4 fw-semibold text-dark">
                                    {{ $item->advance_date?->format('d/m/Y') }}</td>
                            </tr>
                            @if ($item->notes)
                            <tr>
    ...
    <!-- العمود الأيسر: مراحل الاعتمادات (تصميم مطابق للعروض) -->
...
<!-- ============================================================== -->
<!-- القسم السفلي: سجل الاعتمادات (تصميم مطابق للعروض)            -->
<!-- ============================================================== -->
<div class="row mt-4">
    <div class="col-12">
        <div class="card">
