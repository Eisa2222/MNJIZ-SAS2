...
@section('title', 'إضافة عرض سعري')

@section('breadcrumb')
    <li><a href="#">قيود</a></li>
    <li><a href="{{ route('qoyod.quotes.index') }}">عروض الأسعار</a></li>
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#">إضافة عرض سعري</a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة عرض سعري" data-page-url="{{ url()->current() }}"
            onclick="toggleFavorite(event, this)"></i>
    </li>
@endsection

@section('page-script')
    @vite(['resources/assets/js/qoyod/quotes/quotes-request-wizard.js'])
@endsection
...
@section('vendor-script')
    @vite(['resources/assets/js/qoyod/quotes/quotes.js', 'resources/assets/vendor/libs/bs-stepper/bs-stepper.js', 'resources/assets/vendor/libs/select2/select2.js', 'resources/assets/vendor/libs/@form-validation/popular.js', 'resources/assets/vendor/libs/@form-validation/bootstrap5.js', 'resources/assets/vendor/libs/@form-validation/auto-focus.js', 'resources/assets/vendor/libs/sweetalert2/sweetalert2.js'])
    <script>
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-header">
                    <div class="step" data-target="#basic-info">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label mt-1">
                                ...
                                <span class="bs-stepper-subtitle">العميل والبيانات العامة</span>
                            </span>
                        </button>
                    </div>
                    ...
                    <div class="step" data-target="#details-info">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label mt-1">
                                <span class="bs-stepper-title">تفاصيل العرض السعري </span>
                                <span class="bs-stepper-subtitle">التفاصيل الإضافية للعرض السعري</span>
                            </span>
                        </button>
                    </div>
                </div>
                ...
                <div class="bs-stepper-content">
                    ...
                    <form id="form" action="{{ route('qoyod.quotes.store') }}" method="POST">
                        @csrf
                        ...
                        <div id="basic-info" class="content dstepper-block">
                            <div class="row g-3">
                                {{-- المرجع  --}}
                                <div class="col-md-6">
                                    <label for="quotation_no" class="form-label">المرجع
                                ...
                                {{-- العميل (contact_id) --}}
                                <div class="col-md-6">
                                    <label for="contact_id" class="form-label">العميل
                                        <span class="text-danger">*</span></label>
