...
@section('title', 'إضافة إشعار مدين')

@section('breadcrumb')
    <li><a href="#">قيود</a></li>
    <li><a href="{{ route('qoyod.debit-notes.index') }}">الإشعارات المدينة</a></li>
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#"> إضافة إشعار مدين </a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة إشعار مدين" data-page-url="{{ url()->current() }}"
            onclick="toggleFavorite(event, this)"></i>
    </li>
@endsection

@section('page-script')
    @vite(['resources/assets/js/qoyod/notes/debit-notes/debit-notes-request-wizard.js'])
@endsection
...
@section('vendor-script')
    @vite(['resources/assets/js/qoyod/notes/debit-notes/debit-notes.js', 'resources/assets/vendor/libs/bs-stepper/bs-stepper.js', 'resources/assets/vendor/libs/select2/select2.js', 'resources/assets/vendor/libs/@form-validation/popular.js', 'resources/assets/vendor/libs/@form-validation/bootstrap5.js', 'resources/assets/vendor/libs/@form-validation/auto-focus.js', 'resources/assets/vendor/libs/sweetalert2/sweetalert2.js'])
    <script>
        ...
        $(document).ready(function() {
            $('#contact_id').on('change', function() {
                ...
                $('#parent_id').html('<option selected disabled>جارٍ تحميل الفواتير...</option>').trigger(
                    'change');
                $('#loadingIndicator').show(); 

                $.ajax({
                    url: "{{ route('qoyod.bills.get-bills-by-vendor', ':contact_id') }}"
                    ...
                    error: function() {
                        $('#parent_id').html(
                            ...
                            'change');
                        toastr.error('فشل في جلب الفواتير لهذا المورد');
                    }
                });
            });
        });
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    <form id="form" action="{{ route('qoyod.debit-notes.store') }}" method="POST">
                        @csrf
                        ...
                        <div id="basic-info" class="content dstepper-block">
                            <div class="row g-3">
                                ...
                                {{-- المورد (contact_id) --}}
                                <div class="col-md-6">
                                    <label for="contact_id" class="form-label">الموردين <span
                                ...
                                <div class="col-md-6">
                                    <label for="parent_id" class="form-label">فاتورة المشتريات  الأصلية
