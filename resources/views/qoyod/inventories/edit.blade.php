...
@section('title', 'تعديل بيانات موقع')

@section('breadcrumb')
    <li><a href="#">قيود</a></li>
    <li><a href="{{ route('qoyod.inventories.index') }}">المواقع</a></li>
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#">تعديل بيانات موقع</a>
        <i class="ti ti-star favorite-icon" data-page-name="تعديل بيانات موقع" data-page-url="{{ url()->current() }}"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="ar_name" name="ar_name" class="form-control"
                                        value="{{ old('ar_name',$inventory['ar_name']) }}" required />
                                    @error('ar_name')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="account_id" name="account_id" class="select2 form-select"
                                        ...
                                        @foreach ($inventoryAccount as $acc)
                                            <option value="{{ $acc['id'] }}"
                                                {{ old('account_id',$inventory['account_id']) == $acc['id'] ? 'selected' : '' }}>
