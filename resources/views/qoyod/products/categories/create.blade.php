...
@section('title', 'إضافة تصنيف منتجات ')

@section('breadcrumb')
    <li><a href="#">قيود</a></li>
    <li><a href="{{ route('qoyod.categories.index') }}"> أصناف المنتجات</a></li>
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#"> إضافة تصنيف منتجات </a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة  تصنيف منتجات " data-page-url="{{ url()->current() }}"
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    @endif
                    <form id="form" action="{{ route('qoyod.categories.store') }}" method="POST"
                        ...
                        <div id="basic-info" class="content dstepper-block">
                            ...
                            <div class="row  g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <span class="text-danger">*</span>
                                    <textarea name="description" class="form-control" required id="description" rows="3">{{ old('description') }}</textarea>
                                </div>
                            </div>
