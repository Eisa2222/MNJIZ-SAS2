...
@section('breadcrumb')
    <li><a href="#">قيود</a></li>
    <li><a href="{{ route('qoyod.bills.index') }}">فواتير المشتريات</a></li>
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#"> إضافة فاتورة مشتريات </a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة فاتورة مشتريات" data-page-url="{{ url()->current() }}"
            onclick="toggleFavorite(event, this)"></i>
    </li>
@endsection

@section('page-script')
    @vite(['resources/assets/js/qoyod/purchases/bills/bill-request-wizard.js'])
@endsection
...
@section('vendor-script')
    @vite(['resources/assets/js/qoyod/purchases/bills/bill.js', 'resources/assets/vendor/libs/bs-stepper/bs-stepper.js', 'resources/assets/vendor/libs/select2/select2.js', 'resources/assets/vendor/libs/@form-validation/popular.js', 'resources/assets/vendor/libs/@form-validation/bootstrap5.js', 'resources/assets/vendor/libs/@form-validation/auto-focus.js', 'resources/assets/vendor/libs/sweetalert2/sweetalert2.js'])
    <script>
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-header">
                    ...
                    <div class="step" data-target="#details-info">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label mt-1">
                                <span class="bs-stepper-title">تفاصيل فاتورة المشتريات</span>
                                <span class="bs-stepper-subtitle">التفاصيل الإضافية لفاتورة المشتريات</span>
                            </span>
                        </button>
                    </div>
                </div>
                ...
                <div class="bs-stepper-content">
                    ...
                    <form id="form" action="{{ route('qoyod.bills.store') }}" method="POST">
                        @csrf
