...
@section('title', 'إضافة أمر شراء')

@section('breadcrumb')
    <li><a href="#">قيود</a></li>
    <li><a href="{{ route('qoyod.purchase-orders.index') }}">أوامر الشراء</a></li>
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#">إضافة أمر شراء</a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة أمر شراء" data-page-url="{{ url()->current() }}"
            onclick="toggleFavorite(event, this)"></i>
    </li>
@endsection

@section('page-script')
    @vite(['resources/assets/js/qoyod/purchases/purchase_orders/orders-request-wizard.js'])
@endsection
...
@section('vendor-script')
    @vite(['resources/assets/js/qoyod/purchases/purchase_orders/purchase-orders.js', 'resources/assets/vendor/libs/bs-stepper/bs-stepper.js', 'resources/assets/vendor/libs/select2/select2.js', 'resources/assets/vendor/libs/@form-validation/popular.js', 'resources/assets/vendor/libs/@form-validation/bootstrap5.js', 'resources/assets/vendor/libs/@form-validation/auto-focus.js', 'resources/assets/vendor/libs/sweetalert2/sweetalert2.js'])
    <script>
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-header">
                    <div class="step" data-target="#basic-info">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label mt-1">
                                ...
                                <span class="bs-stepper-subtitle">المورد والبيانات العامة</span>
                            </span>
                        </button>
                    </div>
                    ...
                    <div class="step" data-target="#details-info">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label mt-1">
                                <span class="bs-stepper-title">تفاصيل أمر الشراء</span>
                                <span class="bs-stepper-subtitle">التفاصيل الإضافية لأمر الشراء</span>
                            </span>
                        </button>
                    </div>
                </div>
                ...
                <div class="bs-stepper-content">
                    ...
                    <form id="form" action="{{ route('qoyod.purchase-orders.store') }}" method="POST">
                        @csrf
                        ...
                        <div id="basic-info" class="content dstepper-block">
                            <div class="row g-3">
                                {{-- المرجع  --}}
                                <div class="col-md-6">
                                    <label for="reference" class="form-label">المرجع
                                ...
                                {{-- المورد (contact_id) --}}
                                <div class="col-md-6">
                                    <label for="contact_id" class="form-label">المورد
                                        <span class="text-danger">*</span></label>
                                    <select id="contact_id" name="contact_id" class="form-select select2"
                                        data-placeholder="اختر المورد">
                                        <option value="" selected disabled>اختر مورّدًا</option>
                                ...
                                <div class="col-md-6">
                                    <label for="expiry_date" class="form-label">تاريخ الانتهاء <span
                                            class="text-danger">*</span></label>
                                        ...
                                        <table id="lineItemsTable" class="table table-bordered">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th style="width: 25%; font-size: 0.9rem;">المنتج</th>
                                                    <th style="width: 16%; font-size: 0.9rem;">الوصف</th>
                                                    <th style="width: 12%; font-size: 0.9rem;">الكمية</th>
                                                    <th style="width: 12%; font-size: 0.9rem;">سعر الوحدة</th>
                                                    <th style="width: 13%; font-size: 0.9rem;">الخصم</th>
                                                    {{-- <th style="width: 2%; font-size: 0.9rem;">شامل الضريبة؟</th> --}}
                                                    <th rowspan="2"
                                                        style="width: 4%; vertical-align: middle; font-size: 0.9rem;">
                                                        إجراءات</th>
                                                </tr>
