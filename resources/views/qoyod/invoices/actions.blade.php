<div class="d-flex justify-content-center">
    ...
    <form id="delete-form-{{ $row['id'] }}" action="{{ route('qoyod.invoices.destroy', $row['id']) }}" method="POST"
        style="display: none;">
        @csrf
        @method('DELETE')
    </form>
...
<div class="modal fade" id="paymentModal" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="paymentForm" action="{{ route('qoyod.invoice-payments.store') }}" method="POST">
                @csrf
...
<script>
    ...
    function openPaymentModal(invoiceId, reference, companyName, totalAmount) {
