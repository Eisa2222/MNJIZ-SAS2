                    ...
                    <div class="table-responsive">
                        <table class="table table-striped  small text-center">
                            ...
                            <tr>
                                ...
                                <td>{{ $invoice['status'] == 'Approved' ? 'موافق عليه' : 'مسودة' }}</td>
                            </tr>
                            <tr>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold">{{ number_format($invoice['tax_amount'] ?? 0, 2) }} <span
                                            class="icon-saudi_riyal"></span></td>
                                    <td class="fw-bold">{{ number_format($invoice['total'] ?? 0, 2) }} <span
                                            class="icon-saudi_riyal"></span></td>
                                </tr>
                            </tfoot>
                        </table>
        ...
        <div class="col-5">
            <div class="card p-5">
                ...
                <div class="d-flex justify-content-between py-3">
                    ...
                    <span class="fw-bold text-primary ">{{ number_format($invoice['total'] ?? 0, 2) }}
                        <span class="icon-saudi_riyal mx-2"></span>
                    </span>
                </div>
            </div>
