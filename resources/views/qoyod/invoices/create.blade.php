...
@section('breadcrumb')
    <li><a href="#">قيود</a></li>
    <li><a href="{{ route('qoyod.invoices.index') }}">فواتير المبيعات</a></li>
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#"> إضافة فاتورة مبيعات </a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة فاتورة مبيعات" data-page-url="{{ url()->current() }}"
            onclick="toggleFavorite(event, this)"></i>
    </li>
@endsection

@section('page-script')
    @vite(['resources/assets/js/qoyod/invoices/invoice-request-wizard.js'])
@endsection
...
@section('vendor-script')
    @vite(['resources/assets/js/qoyod/invoices/invoice.js', 'resources/assets/vendor/libs/bs-stepper/bs-stepper.js', 'resources/assets/vendor/libs/select2/select2.js', 'resources/assets/vendor/libs/@form-validation/popular.js', 'resources/assets/vendor/libs/@form-validation/bootstrap5.js', 'resources/assets/vendor/libs/@form-validation/auto-focus.js', 'resources/assets/vendor/libs/sweetalert2/sweetalert2.js'])
    <script>
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    <form id="form" action="{{ route('qoyod.invoices.store') }}" method="POST">
                        @csrf
                        ...
                        <div id="basic-info" class="content dstepper-block">
                            <div class="row g-3">
                                ...
                                {{-- العميل (contact_id) --}}
                                <div class="col-md-6">
                                    <label for="contact_id" class="form-label">العملاء
                                        <span class="text-danger">*</span></label>
