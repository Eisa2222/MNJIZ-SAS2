...
@section('title', 'إضافة إستبيان')

@section('breadcrumb')
    <li><a href="{{ route('surveys.index') }}">إدارة الإستبيانات</a></li>
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#">إضافة إستبيان </a>
        <i class="ti ti-star favorite-icon" data-page-name="إضافة إستبيان" data-page-url="{{ url()->current() }}"
        ...
        <div class="col-12">
            <div id="wizard-validation" class="bs-stepper mt-2">
                    ...
                    <div class="step" data-target="#basic-info">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label mt-1">
                                <span class="bs-stepper-title">معلومات الإستبيان</span>
                                <span class="bs-stepper-subtitle">إدخال معلومات الإستبيان الأساسية</span>
                            </span>
                        </button>
                    </div>
                    ...
                    <div class="step" data-target="#additional-info-2">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label">
                                <span class="bs-stepper-title">اسئلة الإستبيان</span>
                                <span class="bs-stepper-subtitle">إضافة اسئلة الإستبيان</span>
                            </span>
                        </button>
                    </div>
                </div>
                <div class="bs-stepper-content">
                    ...
                    @endif
                    <form id="form" action="{{ route('surveys.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div id="basic-info" class="content dstepper-block">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="type" class="form-label">نوع الاستبيان
                                ...
                                <div class="col-md-6">
                                    <label for="title" class="form-label">عنوان الإستبيان
                                        <span class="text-danger">*</span>
                                    </label>
                                ...
                                <div class="col-md-12">
                                    <label for="message_template" class="form-label">قالب الرسالة
                                        <span class="text-danger">*</span>
                                    </label>
                                    <textarea id="message_template" name="message_template" class="form-control" rows="3">{{ old('message_template') }}</textarea>
                                </div>
                        ...
                        <!-- الخطوة الثانية: الأسئلة والإجابات -->
                        ...
                        <!-- قالب خيار الإجابة (مخفي) -->
                        <template id="optionTemplate">
                            <div class="option-item d-flex align-items-center mb-2" data-option-index="">
                                <div class="flex-grow-1 me-2">
                                    <input type="text" name="questions[][options][][option_text]"
                                        class="form-control option-text" placeholder="نص الخيار..." required>
                                </div>
                                <div class="btn-group btn-group-sm">
                        ...
                        <!-- قالب خيار الإجابة (مخفي) -->
                        <!-- اترك تمبليت واحد فقط بهذا الـ id -->
                        <template id="optionTemplate">
                            <div class="option-item d-flex align-items-center mb-2" data-option-index="">
                                <div class="flex-grow-1 me-2">
                                    <!-- بدون name: سنضبطه بالـ JS -->
