...
@section('title', 'إدارة الإستبيانات')

@section('breadcrumb')
    <li class="breadcrumb-item d-flex align-items-center">
        <a href="#">إدارة الإستبيانات</a>
        <i class="ti ti-star favorite-icon" data-page-name="إدارة الإستبيانات" data-page-url="{{ url()->current() }}"
                    ...
                    if (res && res.success) {
                        $badge
                            .removeClass(function(i, cls) {
                                return (cls.match(/bg-\S+/g) || []).join(' ');
                            })
                            .addClass('bg-' + res.color)
                            .text(res.label);

                        toastr.success('تم تغيير الحالة بنجاح.');
                    } else {
                        toastr.error((res && res.message) || 'فشل في تغيير الحالة.');
                    }
                },
                error: function() {
