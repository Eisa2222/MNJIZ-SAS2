...
@section('vendor-style')
    ...
    <style>
        ...
        .form-check-input {
            ...
            height: 20px;
            margin: 0px 5px;
            /* مسافة بين checkbox والحدود */
            appearance: none;
            /* إزالة النمط الافتراضي */
...
@section('vendor-script')
    @vite(['resources/assets/vendor/libs/datatables-bs5/datatables-bootstrap5.js', 'resources/js/app.js', 'resources/assets/vendor/libs/select2/select2.js', 'resources/assets/vendor/libs/sweetalert2/sweetalert2.js', 'resources/assets/js/tasks.js'])
@endsection
@section('toastr')
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#tasks-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('project.tasks', $project->id) }}",
                    data: function(d) {
            ...
            $('#tasks-table tbody').on('click', '.toggle-steps', function() {
                ...
                if (row.child.isShown()) {
                    ...
                    $.ajax({
                        url: '/employees/tasks/' + rowId +
                            '/steps', // تأكد من وجود راوت مناسب
                        method: 'GET',
                        success: function(response) {
...
@section('sections')
    ...
    <div class=" ">
        ...
        {{-- لاضافة مهمة جديدة  --}}
        @include('judicial_affairs.projects.tasks.partials._add_task')
