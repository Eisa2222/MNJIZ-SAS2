// resources/js/contractsReport.js
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // تهيئة جميع المخططات
    initializeChart('contractsByStartStatusChart', 'contractsByStartStatusData', 'contractsByStartStatus', 'العقود_حسب_حالة_البدء.png');
    initializeChart('contractsByStatusChart', 'contractsByStatusData', 'contractsByStatus', 'العقود_حسب_الحالة.png');
    initializeChart('contractsByManagerChart', 'contractsByManagerData', 'contractsByManager', 'العقود_حسب_مسؤول_العقد.png');
    initializeChart('contractsByCustomerChart', 'contractsByCustomerData', 'contractsByCustomer', 'العقود_حسب_العميل.png');

    // المخططات الجديدة
    initializeChart('contractsByExpectedClosureMonthChart', 'contractsByExpectedClosureMonthData', 'contractsByExpectedClosureMonth', 'العقود_حسب_شهر_الإغلاق_المتوقع_هجري.png', 'bar');
    initializeChart('contractsByTimeRemainingChart', 'contractsByTimeRemainingData', 'contractsByTimeRemaining', 'العقود_حسب_الوقت_المتبقي.png');
    initializeChart('contractsByOfferChart', 'contractsByOfferData', 'contractsByOffer', 'العقود_حسب_العرض.png');
    initializeChart('contractsByRelationshipManagerChart', 'contractsByRelationshipManagerData', 'contractsByRelationshipManager', 'العقود_حسب_مسؤول_العلاقة.png');
