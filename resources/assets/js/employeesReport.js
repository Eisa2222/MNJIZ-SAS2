document.addEventListener('DOMContentLoaded', function() {
    ...
    // تهيئة جميع المخططات
    initializeChart('employeesByNationalityChart', 'employeesByNationalityData', 'employeesByNationality', 'الموظفين_حسب_الجنسية.png','bar');
    initializeChart('employeesByJobTitleChart', 'employeesByJobTitleData', 'employeesByJobTitle', 'الموظفين_حسب_المسمى_الوظيفي.png');
    initializeChart('employeesByHRStatusChart', 'employeesByHRStatusData', 'employeesByHRStatus', 'الموظفين_حسب_حالة_الموارد_البشرية.png');
    initializeChart('employeesByHRClassificationChart', 'employeesByHRClassificationData', 'employeesByHRClassification', 'الموظفين_حسب_تصنيف_الموارد_البشرية.png');
    initializeChart('employeesByKnowledgeAreaChart', 'employeesByKnowledgeAreaData', 'employeesByKnowledgeArea', 'الموظفين_حسب_مجال_المعرفة.png');
    initializeChart('employeesByLicenseTypeChart', 'employeesByLicenseTypeData', 'employeesByLicenseType', 'الموظفين_حسب_نوع_الرخصة.png');
    initializeChart('employeesByQualificationDegreeChart', 'employeesByQualificationDegreeData', 'employeesByQualificationDegree', 'الموظفين_حسب_الدرجة_العلمية.png');
    initializeChart('employeesByBirthMonthChart', 'employeesByBirthMonthData', 'employeesByBirthMonth', 'الموظفين_حسب_شهر_الميلاد_هجري.png', 'bar');
    initializeChart('employeesByContractStartMonthChart', 'employeesByContractStartMonthData', 'employeesByContractStartMonth', 'الموظفين_حسب_شهر_بدء_العقد_هجري.png', 'bar');
    initializeChart('employeesByInsuranceStatusChart', 'employeesByInsuranceStatusData', 'employeesByInsuranceStatus', 'الموظفين_حسب_حالة_التأمين.png');
