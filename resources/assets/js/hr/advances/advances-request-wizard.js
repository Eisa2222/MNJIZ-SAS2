...
(function () {
    ...
    steps.forEach((step, index) => {
        const validators = {
            employee_id: {
                validators: {
                    notEmpty: { message: ' الموظف مطلوب' },
                }
            },

            advance_type: {
                validators: {
                    notEmpty: { message: ' نوع السلفية مطلوب' },
                }
            },
            ...
            advance_date: {
                validators: {
                    notEmpty: { message: ' تاريخ السلفية مطلوب' },
                    date: {
                        format: 'YYYY-MM-DD',
            ...
            due_date: {
                validators: {
                    ...
                    callback: {
                        message: 'تاريخ  الاستحقاق  يجب أن يكون بعد تاريخ السلفية',
                        callback: function (input) {
                            const issueDate = document.querySelector('[name="advance_date"]').value;
