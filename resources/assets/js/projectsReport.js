document.addEventListener('DOMContentLoaded', function() {
    ...
    // تهيئة جميع المخططات
    initializeChart('projectsByStatusChart', 'projectsByStatusData', 'projectsByStatus', 'المشاريع_حسب_الحالة.png');
    initializeChart('projectsByManagerChart', 'projectsByManagerData', 'projectsByManager', 'المشاريع_حسب_مدير_المشروع.png');
    initializeChart('projectsByContractChart', 'projectsByContractData', 'projectsByContract', 'المشاريع_حسب_العقد.png');
    initializeChart('projectsByStartMonthChart', 'projectsByStartMonthData', 'projectsByStartMonth', 'المشاريع_حسب_شهر_البدء_هجري.png', 'bar');
    initializeChart('projectsByTimeRemainingChart', 'projectsByTimeRemainingData', 'projectsByTimeRemaining', 'المشاريع_حسب_الوقت_المتبقي.png');
