...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeChart(chartId, dataKey, badgePrefix, downloadFilename) {
        ...
        const chart = createDoughnutChart(ctx, labels, data, backgroundColors);
    ...
    // تهيئة جميع المخططات
    initializeChart('offersByStartStatusChart', 'offersByStartStatusData', 'offersByStartStatus', 'العروض_حسب_حالة_البدء.png');
    initializeChart('offersByStageChart', 'offersByStageData', 'offersByStage', 'العروض_حسب_مرحلة_العرض.png');
    initializeChart('offersByManagerChart', 'offersByManagerData', 'offersByManager', 'العروض_حسب_مدير_العلاقة.png');
    initializeChart('offersByCustomerChart', 'offersByCustomerData', 'offersByCustomer', 'العروض_حسب_العميل.png');
