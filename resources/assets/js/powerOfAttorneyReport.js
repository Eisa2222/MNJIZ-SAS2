// resources/js/powerOfAttorneyReport.js
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // تهيئة جميع المخططات
    initializeChart('powersByStatusChart', 'powersByStatusData', 'powersByStatus', 'الوكالات_حسب_الحالة.png');
    initializeChart('powersByIssuedMonthChart', 'powersByIssuedMonthData', 'powersByIssuedMonth', 'الوكالات_حسب_شهر_الإصدار_هجري.png', 'bar');
    initializeChart('powersByTimeRemainingChart', 'powersByTimeRemainingData', 'powersByTimeRemaining', 'الوكالات_حسب_الوقت_المتبقي.png');
