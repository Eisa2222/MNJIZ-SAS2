            ...
            initComplete: function() {
                ...
                this.api()
                    ...
                    .every(function() {
                        var column = this;
                        var select = $(
                                '<select id="UserRole" class="form-select text-capitalize"><option value=""> اختر الدور   </option></select>'
                            )
                            .appendTo('.user_role')
                            .on('change', function() {
                ...
                this.api()
                    ...
                    .every(function() {
                        var column = this;
                        var select = $(
                                '<select id="UserPlan" class="form-select text-capitalize"><option value=""> اختر الخطة  </option></select>'
                            )
                            .appendTo('.user_plan')
                            .on('change', function() {
                                var val = $.fn.dataTable.util.escapeRegex($(this).val());
                ...
                this.api()
                    ...
                    .every(function() {
                        var column = this;
                        var select = $(
                                '<select id="FilterTransaction" class="form-select text-capitalize"><option value=""> اختر الحالة  </option></select>'
                            )
    ...
    const fv = FormValidation.formValidation(addNewUserForm, {
        fields: {
            userFullname: {
                validators: {
                    notEmpty: {
                        message: ' الرجاء إدخال الإسم الكامل '
                    }
                }
            },
            userEmail: {
