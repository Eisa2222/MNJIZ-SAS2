document.addEventListener('DOMContentLoaded', function() {
    ...
    // تهيئة جميع المخططات
    initializeChart('lawsuitsByStatusChart', 'lawsuitsByStatusData', 'lawsuitsByStatus', 'الدعاوى_حسب_الحالة.png');
    initializeChart('lawsuitsByMainCourtChart', 'lawsuitsByMainCourtData', 'lawsuitsByMainCourt', 'الدعاوى_حسب_المحكمة.png');
    initializeChart('lawsuitsByRegionChart', 'lawsuitsByRegionData', 'lawsuitsByRegion', 'الدعاوى_حسب_المدينة.png');
    initializeChart('lawsuitsByTypeChart', 'lawsuitsByTypeData', 'lawsuitsByType', 'الدعاوى_حسب_نوع_الدعوى.png');
    initializeChart('lawsuitsByCategoryChart', 'lawsuitsByCategoryData', 'lawsuitsByCategory', 'الدعاوى_حسب_التصنيف_الرئيسي.png');
    initializeChart('lawsuitsByCreatedMonthChart', 'lawsuitsByCreatedMonthData', 'lawsuitsByCreatedMonth', 'الدعاوى_حسب_شهر_الإنشاء_هجري.png', 'bar');
    initializeChart('lawsuitsByUserChart', 'lawsuitsByUserData', 'lawsuitsByUser', 'الدعاوى_حسب_المستخدم.png');
