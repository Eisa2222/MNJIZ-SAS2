document.addEventListener('DOMContentLoaded', function() {
    ...
    // تهيئة جميع المخططات
    initializeChart('opponentsByTypeChart', 'opponentsByTypeData', 'opponentsByType', 'الخصوم_حسب_النوع.png');
    initializeChart('opponentsByRegionChart', 'opponentsByRegionData', 'opponentsByRegion', 'الخصوم_حسب_المدينة.png');
    initializeChart('opponentsByCreatedMonthChart', 'opponentsByCreatedMonthData', 'opponentsByCreatedMonth', 'الخصوم_حسب_شهر_الإنشاء_هجري.png', 'bar');
    initializeChart('opponentsByLawsuitCountChart', 'opponentsByLawsuitCountData', 'opponentsByLawsuitCount', 'أعلى_10_خصوم_حسب_عدد_الدعاوى.png');
